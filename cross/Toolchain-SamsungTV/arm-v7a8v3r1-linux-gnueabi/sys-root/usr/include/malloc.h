...
struct trim_res {
  unsigned int trim; /* How much memory can be freed by calling malloc_trim */
  unsigned int used; /* How much bytes are allocated, that are not in 4k/4k pages */
  unsigned int full; /* Number of 4k/4k pages */
  unsigned int total; /* How much bytes in pages that arent fully used */
};

/* Returns a copy of the updated current mallinfo. */
extern struct mallinfo mallinfo (void) __THROW;

extern struct mallinfo vd_mallinfo __MALLOC_P ((void));
