...
public:
  ...
  virtual ::java::rmi::server::RemoteStub *exportObject (::java::rmi::Remote *);
  virtual ::java::rmi::server::RemoteStub *exportObject (::java::rmi::Remote *, ::java::lang::Object *);
  virtual ::java::rmi::server::RemoteStub *getStub () { return stub; }
  virtual jboolean unexportObject (::java::rmi::Remote *, jboolean);
private:
  ::java::lang::Object *getHelperClass (::java::lang::Class *, ::java::lang::String *);
public:
  virtual ::java::lang::String *getClientHost ();
private:
  void buildMethodHash (::java::lang::Class *, jboolean);
public: // actually package-private
