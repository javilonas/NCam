...
export ARCH=mips
export target=mips
export NCAM_BIN=ncam-router-openwrt-ar71xx-libusb.mips
export CROSS=$ROOTFS_PATH/cross/OpenWrt-SDK-15.05-ar71xx-generic_gcc-4.8-linaro_uClibc-0.9.33.2.Linux-x86_64/staging_dir/toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/bin/mips-openwrt-linux-uclibc-
export DCMAKE=cross-mips-routerwrtar71xx-linux-uclibc-libusb
export SCRIPT=build_mips-router-openwrt-ar71xx-libusb.sh

export PATH=$PATH:~$ROOTFS_PATH/cross/OpenWrt-SDK-15.05-ar71xx-generic_gcc-4.8-linaro_uClibc-0.9.33.2.Linux-x86_64/staging_dir/toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/bin
export STAGING_DIR=~/openwrt/staging_dir

export LIB_PTHREAD="$ROOTFS_PATH/cross/OpenWrt-SDK-15.05-ar71xx-generic_gcc-4.8-linaro_uClibc-0.9.33.2.Linux-x86_64/staging_dir/toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/lib/libpthread.a -lrt"
export LIBUSB_LIB="$ROOTFS_PATH/cross/OpenWrt-SDK-15.05-ar71xx-generic_gcc-4.8-linaro_uClibc-0.9.33.2.Linux-x86_64/staging_dir/toolchain-mips_34kc_gcc-4.8-linaro_uClibc-0.9.33.2/lib/libusb-1.0.a -lrt"
