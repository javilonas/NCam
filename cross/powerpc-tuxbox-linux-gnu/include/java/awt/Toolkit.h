...
public:  // actually protected
  ...
  virtual void loadSystemColors (jintArray) { }
public:
...
public:
  ...
  virtual ::java::awt::Insets *getScreenInsets (::java::awt::GraphicsConfiguration *) { return 0; }
  ...
  virtual ::java::awt::Image *createImage (jbyteArray);
  virtual ::java::awt::Image *createImage (jbyteArray, jint, jint) = 0;
  virtual ::java::awt::PrintJob *getPrintJob (::java::awt::Frame *, ::java::lang::String *, ::java::util::Properties *) = 0;
  virtual ::java::awt::PrintJob *getPrintJob (::java::awt::Frame *, ::java::lang::String *, ::java::awt::JobAttributes *, ::java::awt::PageAttributes *) { return 0; }
  virtual void beep () = 0;
  virtual ::java::awt::datatransfer::Clipboard *getSystemClipboard () = 0;
  virtual ::java::awt::datatransfer::Clipboard *getSystemSelection () { return 0; }
...
public:
  virtual ::java::awt::Cursor *createCustomCursor (::java::awt::Image *, ::java::awt::Point *, ::java::lang::String *) { return 0; }
...
public:
  ...
  virtual ::java::awt::dnd::DragGestureRecognizer *createDragGestureRecognizer (::java::lang::Class *, ::java::awt::dnd::DragSource *, ::java::awt::Component *, jint, ::java::awt::dnd::DragGestureListener *) { return 0; }
  ::java::lang::Object *getDesktopProperty (::java::lang::String *);
public:  // actually protected
  void setDesktopProperty (::java::lang::String *, ::java::lang::Object *);
  virtual ::java::lang::Object *lazilyLoadDesktopProperty (::java::lang::String *) { return 0; }
...
public:
  ...
  virtual JArray< ::java::awt::event::AWTEventListener *> *getAWTEventListeners () { return 0; }
  virtual JArray< ::java::awt::event::AWTEventListener *> *getAWTEventListeners (jlong) { return 0; }
