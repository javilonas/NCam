...
#define __GMP_CC "mipsel-openwrt-linux-uclibc-gcc -std=gnu99"
#define __GMP_CFLAGS "-Os -pipe -mno-branch-likely -mips32 -mtune=mips32 -fno-caller-saves -fhonour-copts -Wno-error=unused-but-set-variable -msoft-float -fpic "
