...
/*--------------------------------------------------------------------------------------------------------------*\
\*--------------------------------------------------------------------------------------------------------------*/
#define I2C_DATA_HI    	(*(volatile unsigned int *)(AR7_I2C_BASE + 0x0000))
...
#define I2C_DATA_LOW   	(*(volatile unsigned int *)(AR7_I2C_BASE + 0x0004))
#define I2C_DATA_LOW_DATA_MASK                      (0xFF <<  0)

#define I2C_CONFIG     	(*(volatile unsigned int *)(AR7_I2C_BASE + 0x0008))
#define I2C_CONFIG_SPIKE_MASK(mask)                 ((mask) << 12)
#define I2C_CONFIG_IRQ_MASK                         (0x01 <<  0)

#define I2C_DATA_READ  	(*(volatile unsigned int *)(AR7_I2C_BASE + 0x000C))
...
#define I2C_CLOCK_DIV  	(*(volatile unsigned int *)(AR7_I2C_BASE + 0x0010))
