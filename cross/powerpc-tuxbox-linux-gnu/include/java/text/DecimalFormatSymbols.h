...
public:
  ...
  ::java::lang::String *getCurrencySymbol () { return currencySymbol; }
  jchar getDecimalSeparator () { return decimalSeparator; }
  jchar getDigit () { return digit; }
public: // actually package-private
  jchar getExponential () { return exponential; }
public:
  jchar getGroupingSeparator () { return groupingSeparator; }
  ::java::lang::String *getInfinity () { return infinity; }
  ::java::lang::String *getInternationalCurrencySymbol () { return intlCurrencySymbol; }
  jchar getMinusSign () { return minusSign; }
  jchar getMonetaryDecimalSeparator () { return monetarySeparator; }
  ::java::lang::String *getNaN () { return NaN; }
  jchar getPatternSeparator () { return patternSeparator; }
  jchar getPercent () { return percent; }
  jchar getPerMill () { return perMill; }
  jchar getZeroDigit () { return zeroDigit; }
  jint hashCode ();
