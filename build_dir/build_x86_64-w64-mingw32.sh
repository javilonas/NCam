...
export CC=$ROOTFS_PATH/usr/bin/x86_64-w64-mingw32-gcc
export RANLIB=$ROOTFS_PATH/usr/bin/x86_64-w64-mingw32-gcc-ranlib
export PATH="$CROSS:$PATH"
export DCMAKE=cross-x86_64-pc-w64-mingw32
export SCRIPT=build_x86_64-w64-mingw32.sh
