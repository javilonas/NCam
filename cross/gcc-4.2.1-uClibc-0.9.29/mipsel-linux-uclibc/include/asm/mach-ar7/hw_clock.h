...
struct _hw_clock {
    union __clock_PDCR {
        struct _clock_PDCR {
            ...
            unsigned int ut1p      : 1;
            unsigned int iicp      : 1;
            unsigned int vdmap     : 1;
            unsigned int gpiop     : 1;
            unsigned int vlynq1p   : 1;
            unsigned int sarp      : 1;
            unsigned int adslp     : 1;
            unsigned int emifp     : 1;
            unsigned int reserved0 : 1;
            unsigned int adspp     : 1;
            unsigned int ramp      : 1;
            unsigned int romp      : 1;
            unsigned int dmap      : 1;
            ...
            unsigned int emac0p    : 1;
            unsigned int reserved2 : 1;
            unsigned int emac1p    : 1;
            unsigned int reserved3 : 1;
            unsigned int ephyp     : 1;
            unsigned int reserved4 : 2;
            unsigned int vlynq0p   : 1;
            unsigned int reserved5 : 2;
            unsigned int glbpd     : 2;
        } Bits;
        volatile unsigned int Register;
    } PDCR;
    ...
    union __clock_PLLCR ACLKPLLCR0;
    unsigned int reserved9[(0xA0 - 0x94)/sizeof(unsigned int)];
    union __clock_CR0 ACLKCR1;
