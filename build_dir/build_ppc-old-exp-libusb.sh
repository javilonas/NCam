...
export ARCH=ppc
export target=ppc
export NCAM_BIN=ncam-libusb.ppc-old-exp
...
export DCMAKE=cross-powerpc-tuxbox-linux-exp-libusb
export SCRIPT=build_ppc-old-exp-libusb.sh
...
export LIBUSB_LIB="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox/lib/libusb-1.0.a -lrt"
