...
#define AR7_MCDMA_BASE_1 (AR7_MCDMA_BASE & 0x1fffffff)

/* DMA controller registers */

/* DMA channel 0 */
#define DMA_CHANNEL0            0x0
#define DMA0_SOURCE_ADDR        AR7_MCDMA_BASE_1 + 0x0  /* source address */
#define DMA0_DEST_ADDR          AR7_MCDMA_BASE_1 + 0x4  /* destination address */
#define DMA0_TRANS_CTRL         AR7_MCDMA_BASE_1 + 0x8  /* transfer control */
                                                               
/* DMA channel 1 */                                            
#define DMA_CHANNEL1            0x1                            
#define DMA1_SOURCE_ADDR        AR7_MCDMA_BASE_1 + 0x40 /* source address */
#define DMA1_DEST_ADDR          AR7_MCDMA_BASE_1 + 0x44 /* destination address */
#define DMA1_TRANS_CTRL         AR7_MCDMA_BASE_1 + 0x48 /* transfer control */
                                                               
/* DMA channel 2 */                                            
#define DMA_CHANNEL2            0x2                            
#define DMA2_SOURCE_ADDR        AR7_MCDMA_BASE_1 + 0x80 /* source address */
#define DMA2_DEST_ADDR          AR7_MCDMA_BASE_1 + 0x84 /* destination address */
#define DMA2_TRANS_CTRL         AR7_MCDMA_BASE_1 + 0x88 /* transfer control */
                                                               
/* DMA channel 3 */                                            
#define DMA_CHANNEL3            0x3                            
#define DMA3_SOURCE_ADDR        AR7_MCDMA_BASE_1 + 0xC0 /* source address */
#define DMA3_DEST_ADDR          AR7_MCDMA_BASE_1 + 0xC4 /* destination address */
#define DMA3_TRANS_CTRL         AR7_MCDMA_BASE_1 + 0xC8 /* transfer control */
