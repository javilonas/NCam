...
#endif
#ifdef GENERATOR_FILE
extern int align_arrays;
#else
  int x_align_arrays;
#define align_arrays global_options.x_align_arrays
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_delete_first_body_in_unroller;
#else
  int x_flag_delete_first_body_in_unroller;
#define flag_delete_first_body_in_unroller global_options.x_flag_delete_first_body_in_unroller
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_optimization
{
  ...
  signed char x_flag_delete_first_body_in_unroller;
...
enum opt_code
{
  ...
  OPT_falign_arrays_ = 410,                  /* -falign-arrays= */
  OPT_falign_commons = 411,                  /* -falign-commons */
  OPT_falign_functions = 412,                /* -falign-functions */
  OPT_falign_functions_ = 413,               /* -falign-functions= */
  OPT_falign_jumps = 414,                    /* -falign-jumps */
  OPT_falign_jumps_ = 415,                   /* -falign-jumps= */
  OPT_falign_labels = 416,                   /* -falign-labels */
  OPT_falign_labels_ = 417,                  /* -falign-labels= */
  OPT_falign_loops = 418,                    /* -falign-loops */
  OPT_falign_loops_ = 419,                   /* -falign-loops= */
  OPT_fall_intrinsics = 420,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 421, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 422,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 423, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 424, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 425, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 426, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 427, */  /* -fargument-noalias-global */
  OPT_fargument_restrict = 428,              /* -fargument-restrict */
  OPT_fasm = 429,                            /* -fasm */
  ...
  OPT_fdelete_first_body_in_unroller = 498,  /* -fdelete-first-body-in-unroller */
  OPT_fdelete_null_pointer_checks = 499,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 500,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 501,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 502,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 503,                /* -fdirectives-only */
  OPT_fdisable_assertions = 504,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 505,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 506,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 507,         /* -fdollars-in-identifiers */
  OPT_fdse = 508,                            /* -fdse */
  OPT_fdump_ = 509,                          /* -fdump- */
  OPT_fdump_core = 510,                      /* -fdump-core */
  OPT_fdump_final_insns = 511,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 512,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 513,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 514,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 515,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 516,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 517,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 518,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 519,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 520,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 521,                 /* -fearly-inlining */
  OPT_felide_constructors = 522,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 523,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 524, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 525,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 526,        /* -femit-class-debug-always */
  OPT_femit_class_file = 527,                /* -femit-class-file */
  OPT_femit_class_files = 528,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 529,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 530,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 531,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 532,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 533,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 534,               /* -fenable-icf-debug */
  OPT_fencoding_ = 535,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 536,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 537, */           /* -fenum-int-equiv */
  OPT_fexceptions = 538,                     /* -fexceptions */
  OPT_fexcess_precision_ = 539,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 540,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 541,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 542,                       /* -fextdirs= */
  OPT_fextended_identifiers = 543,           /* -fextended-identifiers */
  OPT_fexternal_blas = 544,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 545, */       /* -fexternal-templates */
  OPT_ff2c = 546,                            /* -ff2c */
  OPT_ffast_math = 547,                      /* -ffast-math */
  ...
  OPT_fira_coalesce_range = 626,             /* -fira-coalesce-range */
  ...
  OPT_floop_block = 641,                     /* -floop-block */
  OPT_floop_flatten = 642,                   /* -floop-flatten */
  OPT_floop_interchange = 643,               /* -floop-interchange */
  /* OPT_floop_optimize = 644, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 645,           /* -floop-parallelize-all */
  OPT_floop_post_opt = 646,                  /* -floop-post-opt */
  ...
  OPT_fprefetch_nonconst_step = 721,         /* -fprefetch-nonconst-step */
  OPT_fprefetch_store = 722,                 /* -fprefetch-store */
  OPT_fpreprocessed = 723,                   /* -fpreprocessed */
  OPT_fpretty_templates = 724,               /* -fpretty-templates */
  OPT_fprofile = 725,                        /* -fprofile */
  OPT_fprofile_arcs = 726,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 727,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 728,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 729,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 730,              /* -fprofile-generate= */
  OPT_fprofile_use = 731,                    /* -fprofile-use */
  OPT_fprofile_use_ = 732,                   /* -fprofile-use= */
  OPT_fprofile_values = 733,                 /* -fprofile-values */
  OPT_fprotect_parens = 734,                 /* -fprotect-parens */
  OPT_frandom_seed = 735,                    /* -frandom-seed */
  OPT_frandom_seed_ = 736,                   /* -frandom-seed= */
  OPT_frange_check = 737,                    /* -frange-check */
  OPT_frealloc_lhs = 738,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 739,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 740,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 741,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 742,                /* -frecord-marker=8 */
  OPT_frecursive = 743,                      /* -frecursive */
  OPT_freduce_passed_addressof = 744,        /* -freduce-passed-addressof */
  OPT_freduced_reflection = 745,             /* -freduced-reflection */
  OPT_freg_struct_return = 746,              /* -freg-struct-return */
  OPT_fregmove = 747,                        /* -fregmove */
  OPT_frename_registers = 748,               /* -frename-registers */
  OPT_freorder_blocks = 749,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 750,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 751,              /* -freorder-functions */
  OPT_frepack_arrays = 752,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 753,           /* -freplace-objc-classes */
  OPT_frepo = 754,                           /* -frepo */
  OPT_frequire_return_statement = 755,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 756,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 757, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 758,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 759,                    /* -fresolution= */
  OPT_frounding_math = 760,                  /* -frounding-math */
  OPT_frtti = 761,                           /* -frtti */
  OPT_fsaw_java_file = 762,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 763,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 764,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 765,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 766,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 767,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 768,                 /* -fsched-pressure */
  OPT_fsched_pressure_algorithm_ = 769,      /* -fsched-pressure-algorithm= */
  OPT_fsched_rank_heuristic = 770,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 771,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 772,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 773,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 774,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 775,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 776,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 777,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 778,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 779,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 780,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 781, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 782,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 783,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 784,              /* -fsecond-underscore */
  OPT_fsection_anchors = 785,                /* -fsection-anchors */
  /* OPT_fsee = 786, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 787,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 788,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 789, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 790,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 791,          /* -fselective-scheduling2 */
  OPT_fshort_double = 792,                   /* -fshort-double */
  OPT_fshort_enums = 793,                    /* -fshort-enums */
  OPT_fshort_wchar = 794,                    /* -fshort-wchar */
  OPT_fshow_column = 795,                    /* -fshow-column */
  OPT_fsign_zero = 796,                      /* -fsign-zero */
  OPT_fsignaling_nans = 797,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 798,               /* -fsigned-bitfields */
  OPT_fsigned_char = 799,                    /* -fsigned-char */
  OPT_fsigned_zeros = 800,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 801,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 802,               /* -fsource-filename= */
  OPT_fsource_ = 803,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 804,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 805,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 806,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 807, */                 /* -fsquangle */
  /* OPT_fstack_check = 808, */              /* -fstack-check */
  OPT_fstack_check_ = 809,                   /* -fstack-check= */
  OPT_fstack_limit = 810,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 811,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 812,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 813,                /* -fstack-protector */
  OPT_fstack_protector_all = 814,            /* -fstack-protector-all */
  OPT_fstack_usage = 815,                    /* -fstack-usage */
  OPT_fstats = 816,                          /* -fstats */
  OPT_fstore_check = 817,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 818, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 819,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 820,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 821,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 822, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 823,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 824,                    /* -fsyntax-only */
  OPT_ftabstop_ = 825,                       /* -ftabstop= */
  /* OPT_ftarget_help = 826, */              /* -ftarget-help */
  OPT_ftarget_ = 827,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 828, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 829,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 830,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 831, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 832,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 833,             /* -fthreadsafe-statics */
  OPT_ftime_report = 834,                    /* -ftime-report */
  OPT_ftls_model_ = 835,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 836,               /* -ftoplevel-reorder */
  OPT_ftracer = 837,                         /* -ftracer */
  ...
  OPT_ftree_copy_prop = 844,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 845,                /* -ftree-copyrename */
  OPT_ftree_cselim = 846,                    /* -ftree-cselim */
  OPT_ftree_dce = 847,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 848,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 849,                       /* -ftree-dse */
  OPT_ftree_forwprop = 850,                  /* -ftree-forwprop */
  OPT_ftree_fre = 851,                       /* -ftree-fre */
  ...
  OPT_ftree_pta = 864,                       /* -ftree-pta */
  OPT_ftree_reassoc = 865,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 866, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 867,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 868,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 869,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 870,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 871, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 872, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 873,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 874,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 875,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 876,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 877,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 878,                       /* -ftree-vrp */
  OPT_funderscoring = 879,                   /* -funderscoring */
  OPT_funit_at_a_time = 880,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 881,               /* -funroll-all-loops */
  OPT_funroll_loops = 882,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 883,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 884,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 885,             /* -funsigned-bitfields */
  OPT_funsigned_char = 886,                  /* -funsigned-char */
  OPT_funswitch_loops = 887,                 /* -funswitch-loops */
  OPT_funwind_tables = 888,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 889,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 890,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 891,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 892,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 893,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 894,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 895,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 896,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 897,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 898,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 899, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 900,                /* -fvect-cost-model */
  OPT_fverbose_asm = 901,                    /* -fverbose-asm */
  /* OPT_fversion = 902, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 903,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 904,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 905,                    /* -fvisibility= */
  OPT_fvpt = 906,                            /* -fvpt */
  /* OPT_fvtable_gc = 907, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 908, */            /* -fvtable-thunks */
  OPT_fweak = 909,                           /* -fweak */
  OPT_fweb = 910,                            /* -fweb */
  OPT_fwhole_file = 911,                     /* -fwhole-file */
  OPT_fwhole_program = 912,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 913,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 914,              /* -fworking-directory */
  OPT_fwpa = 915,                            /* -fwpa */
  OPT_fwrapv = 916,                          /* -fwrapv */
  /* OPT_fxref = 917, */                     /* -fxref */
  OPT_fzee = 918,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 919,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 920,                      /* -fzero-link */
  OPT_g = 921,                               /* -g */
  OPT_gant = 922,                            /* -gant */
  OPT_gcoff = 923,                           /* -gcoff */
  OPT_gdwarf_ = 924,                         /* -gdwarf- */
  OPT_gen_decls = 925,                       /* -gen-decls */
  OPT_ggdb = 926,                            /* -ggdb */
  OPT_gnat = 927,                            /* -gnat */
  OPT_gnatO = 928,                           /* -gnatO */
  OPT_gno_strict_dwarf = 929,                /* -gno-strict-dwarf */
  ...
  OPT_mabi_ = 953,                           /* -mabi= */
  OPT_mabort_on_noreturn = 954,              /* -mabort-on-noreturn */
  OPT_mandroid = 955,                        /* -mandroid */
  OPT_mapcs = 956,                           /* -mapcs */
  OPT_mapcs_float = 957,                     /* -mapcs-float */
  OPT_mapcs_frame = 958,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 959,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 960,               /* -mapcs-stack-check */
  OPT_march_ = 961,                          /* -march= */
  OPT_marm = 962,                            /* -marm */
  OPT_mbig_endian = 963,                     /* -mbig-endian */
  OPT_mbionic = 964,                         /* -mbionic */
  OPT_mbxret = 965,                          /* -mbxret */
  OPT_mcallee_super_interworking = 966,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 967,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 968,       /* -mcirrus-fix-invalid-insns */
  OPT_mcond_exec = 969,                      /* -mcond-exec */
  OPT_mcpu_ = 970,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 971,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 972,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 973,                   /* -mfp16-format= */
  OPT_mfp_ = 974,                            /* -mfp= */
  OPT_mfpe = 975,                            /* -mfpe */
  OPT_mfpe_ = 976,                           /* -mfpe= */
  OPT_mfpu_ = 977,                           /* -mfpu= */
  OPT_mfused_mac = 978,                      /* -mfused-mac */
  OPT_mglibc = 979,                          /* -mglibc */
  OPT_mhard_float = 980,                     /* -mhard-float */
  OPT_miwmmxt_use_aggressive_realign = 981,  /* -miwmmxt-use-aggressive-realign */
  OPT_miwmmxt_use_realign = 982,             /* -miwmmxt-use-realign */
  OPT_mldrd_strd = 983,                      /* -mldrd-strd */
  OPT_mlittle_endian = 984,                  /* -mlittle-endian */
  OPT_mlong_calls = 985,                     /* -mlong-calls */
  OPT_mmarvell_div = 986,                    /* -mmarvell-div */
  OPT_mmemcpy_ninsn_ = 987,                  /* -mmemcpy-ninsn= */
  OPT_mneon_no_always_misalign = 988,        /* -mneon-no-always-misalign */
  OPT_mpic_register_ = 989,                  /* -mpic-register= */
  OPT_mpoke_function_name = 990,             /* -mpoke-function-name */
  OPT_mpromote_inline_asm_input_int = 991,   /* -mpromote-inline-asm-input-int */
  OPT_msched_prolog = 992,                   /* -msched-prolog */
  OPT_msched1_ = 993,                        /* -msched1= */
  OPT_msched2_ = 994,                        /* -msched2= */
  OPT_msingle_pic_base = 995,                /* -msingle-pic-base */
  OPT_msoft_float = 996,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 997,       /* -mstructure-size-boundary= */
  OPT_mthumb = 998,                          /* -mthumb */
  OPT_mthumb_cbz = 999,                      /* -mthumb-cbz */
  OPT_mthumb_interwork = 1000,               /* -mthumb-interwork */
  OPT_mtp_ = 1001,                           /* -mtp= */
  OPT_mtpcs_frame = 1002,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1003,               /* -mtpcs-leaf-frame */
  OPT_mtune_ldrd = 1004,                     /* -mtune-ldrd */
  OPT_mtune_ = 1005,                         /* -mtune= */
  OPT_muclibc = 1006,                        /* -muclibc */
  OPT_munaligned_access = 1007,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1008,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1009,      /* -mvectorize-with-neon-quad */
  OPT_mwmmxt = 1010,                         /* -mwmmxt */
  OPT_mword_relocations = 1011,              /* -mword-relocations */
  OPT_mwords_little_endian = 1012,           /* -mwords-little-endian */
  OPT_n = 1013,                              /* -n */
  OPT_no_canonical_prefixes = 1014,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1015,              /* -no-integrated-cpp */
  OPT_nocpp = 1016,                          /* -nocpp */
  OPT_nodefaultlibs = 1017,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1018,                   /* -nostartfiles */
  OPT_nostdinc = 1019,                       /* -nostdinc */
  OPT_nostdinc__ = 1020,                     /* -nostdinc++ */
  OPT_nostdlib = 1021,                       /* -nostdlib */
  OPT_o = 1022,                              /* -o */
  OPT_p = 1023,                              /* -p */
  OPT_pass_exit_codes = 1024,                /* -pass-exit-codes */
  OPT_pedantic = 1025,                       /* -pedantic */
  OPT_pedantic_errors = 1026,                /* -pedantic-errors */
  OPT_pg = 1027,                             /* -pg */
  OPT_pie = 1028,                            /* -pie */
  OPT_pipe = 1029,                           /* -pipe */
  OPT_posix = 1030,                          /* -posix */
  OPT_print_file_name_ = 1031,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1032,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1033,          /* -print-multi-directory */
  OPT_print_multi_lib = 1034,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1035,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1036,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1037,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1038,               /* -print-prog-name= */
  OPT_print_search_dirs = 1039,              /* -print-search-dirs */
  OPT_print_sysroot = 1040,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1041,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1042,                        /* -profile */
  OPT_pthread = 1043,                        /* -pthread */
  OPT_quiet = 1044,                          /* -quiet */
  OPT_r = 1045,                              /* -r */
  OPT_rdynamic = 1046,                       /* -rdynamic */
  OPT_remap = 1047,                          /* -remap */
  OPT_s = 1048,                              /* -s */
  OPT_s_bc_abi = 1049,                       /* -s-bc-abi */
  OPT_save_temps = 1050,                     /* -save-temps */
  OPT_save_temps_ = 1051,                    /* -save-temps= */
  OPT_shared = 1052,                         /* -shared */
  OPT_shared_libgcc = 1053,                  /* -shared-libgcc */
  /* OPT_specs = 1054, */                    /* -specs */
  OPT_specs_ = 1055,                         /* -specs= */
  OPT_static = 1056,                         /* -static */
  OPT_static_libgcc = 1057,                  /* -static-libgcc */
  OPT_static_libgcj = 1058,                  /* -static-libgcj */
  OPT_static_libgfortran = 1059,             /* -static-libgfortran */
  OPT_static_libgo = 1060,                   /* -static-libgo */
  OPT_static_libstdc__ = 1061,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1062, */                /* -std=c++03 */
  OPT_std_c__0x = 1063,                      /* -std=c++0x */
  OPT_std_c__98 = 1064,                      /* -std=c++98 */
  OPT_std_c1x = 1065,                        /* -std=c1x */
  /* OPT_std_c89 = 1066, */                  /* -std=c89 */
  OPT_std_c90 = 1067,                        /* -std=c90 */
  OPT_std_c99 = 1068,                        /* -std=c99 */
  /* OPT_std_c9x = 1069, */                  /* -std=c9x */
  OPT_std_f2003 = 1070,                      /* -std=f2003 */
  OPT_std_f2008 = 1071,                      /* -std=f2008 */
  OPT_std_f95 = 1072,                        /* -std=f95 */
  OPT_std_gnu = 1073,                        /* -std=gnu */
  OPT_std_gnu__0x = 1074,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1075,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1076,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1077, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1078,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1079,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1080, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1081, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1082,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1083, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1084, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1085,                     /* -std=legacy */
  OPT_symbolic = 1086,                       /* -symbolic */
  OPT_t = 1087,                              /* -t */
  OPT_time = 1088,                           /* -time */
  OPT_time_ = 1089,                          /* -time= */
  OPT_tno_android_cc = 1090,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1091,                 /* -tno-android-ld */
  OPT_traditional = 1092,                    /* -traditional */
  OPT_traditional_cpp = 1093,                /* -traditional-cpp */
  OPT_trigraphs = 1094,                      /* -trigraphs */
  OPT_u = 1095,                              /* -u */
  OPT_undef = 1096,                          /* -undef */
  OPT_v = 1097,                              /* -v */
  OPT_version = 1098,                        /* -version */
  OPT_w = 1099,                              /* -w */
  OPT_wrapper = 1100,                        /* -wrapper */
  OPT_x = 1101,                              /* -x */
  OPT_z = 1102,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
