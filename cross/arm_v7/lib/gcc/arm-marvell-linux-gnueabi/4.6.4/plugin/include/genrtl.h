...
#define gen_rtx_CONCAT_TWO(MODE, ARG0, ARG1) \
  gen_rtx_fmt_ee (CONCAT_TWO, (MODE), (ARG0), (ARG1))
#define gen_rtx_CONCAT_THREE(MODE, ARG0, ARG1, ARG2) \
  gen_rtx_fmt_eee (CONCAT_THREE, (MODE), (ARG0), (ARG1), (ARG2))
#define gen_rtx_GET_HALF(MODE, ARG0, ARG1) \
  gen_rtx_fmt_ee (GET_HALF, (MODE), (ARG0), (ARG1))
#define gen_rtx_GET_PART(MODE, ARG0, ARG1) \
  gen_rtx_fmt_ee (GET_PART, (MODE), (ARG0), (ARG1))
