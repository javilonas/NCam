...
static inline int __printk(const char * fmt, ...) __attribute__ ((format (printf, 1, 2)));
static inline int __printk(const char *s, ...) { return 0; }
static inline void restore_printk(void) { return; }
static inline void set_printk(int (*__print)(const char * fmt, ...) __attribute__ ((format (printf, 1, 2))));
static inline void set_printk(int (*__print)(const char * fmt, ...) __attribute__ ((format (printf, 1, 2)))) { return; }
#endif
