...
public:
  virtual ::java::util::Locale *getDefaultLocale () { return defaultLocale; }
public: // actually package-private
...
private:
  ...
  friend class javax_swing_UIDefaults$ProxyLazyValue;
  friend class javax_swing_UIDefaults$LazyValue;
  friend class javax_swing_UIDefaults$LazyInputMap;
  friend class javax_swing_UIDefaults$ActiveValue;
public:
