...
struct parport_pc_via_data
{
	...
	__u8 via_pci_parport_irq_reg;
	/* ISA PnP DMA request routing register */
	__u8 via_pci_parport_dma_reg;
	/* Register and value to enable SuperIO configuration access */
	__u8 via_pci_superio_config_reg;
	__u8 via_pci_superio_config_data;
	/* SuperIO function register number */
	__u8 viacfg_function;
	/* parallel port control register number */
	__u8 viacfg_parport_control;
	/* Parallel port base address register */
	__u8 viacfg_parport_base;
};
