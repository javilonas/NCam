...
export ARCH=mips
export target=mips
export NCAM_BIN=ncam-router-openwrt-brcm63xx.mips
...
export DCMAKE=cross-mips-routerwrtbrcm63xx-linux-uclibc
export SCRIPT=build_mips-router-openwrt-brcm63xx.sh
