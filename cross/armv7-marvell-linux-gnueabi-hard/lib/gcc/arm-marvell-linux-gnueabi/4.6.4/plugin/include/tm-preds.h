/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/gccbuilder-i386/work/mgcc4.6/src/gcc-src/gcc/config/arm/arm.md'.  */
...
extern int base_update_memory_operand (rtx, enum machine_mode);
...
extern int const_extract_size_operand (rtx, enum machine_mode);
extern int const_extract_pos_operand (rtx, enum machine_mode);
...
extern int men_or_reg_operand (rtx, enum machine_mode);
...
extern int imm_for_neon_vshll_operand (rtx, enum machine_mode);
extern int imm_for_neon_vshrn_operand (rtx, enum machine_mode);
...
extern int iwmmxt_mem_or_reg_operand (rtx, enum machine_mode);
extern int imm_or_sreg_operand (rtx, enum machine_mode);
