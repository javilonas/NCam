...
export ARCH=arm
export target=arm
export NCAM_BIN=ncam.arm-mca
export CROSS=$ROOTFS_PATH/cross/Toolchain-Matrix/bin/arm-none-linux-gnueabi-
export CC=$ROOTFS_PATH/cross/Toolchain-Matrix/bin/arm-none-linux-gnueabi-gcc
export RANLIB=$ROOTFS_PATH/cross/Toolchain-Matrix/bin/arm-none-linux-gnueabi-ranlib
export DCMAKE=mca
export SCRIPT=build_arm-mca.sh

export EXTRA_LIBS="-lrt"

export EXTRA_LDFLAGS="-L$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/lib/"

export OPENSSLDIR=$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/include/openssl/

export LIB_RT="$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/lib/librt.a -lrt"
export LIB_PTHREAD="$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/lib/libpthread.a -lrt"
export LIBCRYPT="$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/lib/libcrypt.a -lrt"

export LIBCRYPTO="$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/lib/libcrypto.a -lrt"
export LIB_SSL="$ROOTFS_PATH/cross/Toolchain-Matrix/arm-none-linux-gnueabi/libc/usr/lib/libssl.a -lrt"
