...
/* add by ahsu, 20080407, for big endian option */
#if TARGET_BIG_ENDIAN_DEFAULT
#define ASM_BE "-EB"
#define LD_BE "-EB"
#else
...
#if TARGET_BIG_ENDIAN_DEFAULT
#define TARGET_LINKER_EMULATION "armelfb " LD_BE
#define BE8_LINK_SPEC " %{march=armv7-a|mcpu=cortex-a5"\
  "|mcpu=cortex-a7"\
  "|mcpu=cortex-a8|mcpu=cortex-a9|mcpu=cortex-a15|mcpu=generic-armv7-a"\
  "|mcpu=marvell-fv7|mcpu=marvell-pj4|mcpu=marvell-pj4b|mcpu=marvell-pj4c"\
  "|mcpu=marvell-whitney"\
  ":%{!r:--be8}}"
#else
#define TARGET_LINKER_EMULATION "armelf"
...
#define SUBTARGET_EXTRA_ASM_SPEC \
  "%{mabi=apcs-gnu|mabi=atpcs:-meabi=gnu;:-meabi=5}" TARGET_FIX_V4BX_SPEC ASM_BE
