...
#define UNSPEC_UNALIGNED_LOAD 30
#define FPA_F0_REGNUM 16
#define UNSPEC_PIC_UNIFIED 29
...
#define UNSPEC_UNALIGNED_STORE 31
#define CC_REGNUM 24
...
#define UNSPEC_WALIGNI 618
#define UNSPEC_VMLS_LANE 123
#define UNSPEC_VHSUB 98
#define VUNSPEC_SYNC_RELEASE 26
...
enum unspec {
  UNSPEC_REDUC_UPLUS = 0,
  UNSPEC_WUSUM = 1,
  UNSPEC_VMOV_INTYRR = 2,
  UNSPEC_VEC_WSLLD = 3,
  UNSPEC_VEC_WSRLD = 4,
  UNSPEC_VEC_WUNPCKIHH = 5,
  UNSPEC_VEC_WUNPCKILH = 6,
  UNSPEC_VEC_REALIGN = 7,
  UNSPEC_WADDC = 8,
  UNSPEC_WABS = 9,
  UNSPEC_WQMULWMR = 10,
  UNSPEC_WQMULMR = 11,
