...
#define MIPS_OHIO_SERIAL_PORT_DEFNS \
        {   .baud_base = OHIO_BASE_BAUD, \
            .irq = OHIOINT_UART0, \
            .iomem_base =  (u8*)OHIO_UART0_BASE, \
            .iomem_reg_shift = 2, \
            .flags = ASYNC_BOOT_AUTOCONF | ASYNC_SKIP_TEST, \
            .io_type = UPIO_MEM \
        },
...
#define MIPS_AR7_SERIAL_PORT_DEFNS \
        {   .baud_base = AR7_BASE_BAUD, \
            .irq = AR7INT_UART0, \
            .iomem_base =  (u8*)AR7_UART0_BASE, \
            .iomem_reg_shift = 2, \
            .flags = ASYNC_BOOT_AUTOCONF | ASYNC_SKIP_TEST, \
            .io_type = UPIO_MEM \
        },
...
#define MIPS_UR8_SERIAL_PORT_DEFNS \
        {   .baud_base = UR8_BASE_BAUD, \
            .irq = UR8INT_UART0, \
            .iomem_base =  (u8*)UR8_UART0_BASE, \
            .iomem_reg_shift = 2, \
            .flags = ASYNC_BOOT_AUTOCONF | ASYNC_SKIP_TEST, \
            .io_type = UPIO_MEM \
        },
