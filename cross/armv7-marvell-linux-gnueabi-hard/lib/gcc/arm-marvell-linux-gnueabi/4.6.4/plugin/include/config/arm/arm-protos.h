...
extern void iwmmxt_expand_vector_init (rtx, rtx);
extern int iwmmxt_expand_vector_mov (rtx, rtx, enum machine_mode);

extern int cirrus_memory_offset (rtx);
extern int arm_coproc_mem_operand (rtx, bool);
extern int arm_coproc_mem_operand2 (rtx, bool);
...
extern const char *arm_output_iwmmxt_shift_immediate (const char *, rtx *, int);
...
extern unsigned int __attribute__((pure)) arm_tune_align_size (const tree exp, const bool is_local_alignment);
