...
extern void avalanche_spi_bitbang_cleanup(const struct spi_device *spi);
extern int avalanche_spi_bitbang_transfer(struct spi_device *spi, struct spi_message *m);
