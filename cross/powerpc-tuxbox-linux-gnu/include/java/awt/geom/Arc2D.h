...
public:
  ...
  virtual jint getArcType () { return type; }
...
public:
  ...
  static const jint OPEN = 0L;
  static const jint CHORD = 1L;
  static const jint PIE = 2L;
private:
  jint __attribute__((aligned(__alignof__( ::java::awt::geom::RectangularShape ))))  type;

  friend class java_awt_geom_Arc2D$Float;
  friend class java_awt_geom_Arc2D$Double;
  friend class java_awt_geom_Arc2D$ArcIterator;
public:
