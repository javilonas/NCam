...
#define HAVE_roriv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_roriv2si3 (TARGET_REALLY_IWMMXT)
#define HAVE_roridi3 (TARGET_REALLY_IWMMXT)
...
#define HAVE_ashriv4hi3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_ashriv2si3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_ashridi3_iwmmxt (TARGET_REALLY_IWMMXT)
...
#define HAVE_lshriv4hi3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_lshriv2si3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_lshridi3_iwmmxt (TARGET_REALLY_IWMMXT)
...
#define HAVE_ashliv4hi3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_ashliv2si3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_ashlidi3_iwmmxt (TARGET_REALLY_IWMMXT)
...
#define HAVE_iwmmxt_movv2si_yrr (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_movv4hi_yrr (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_movv8qi_yrr (TARGET_REALLY_IWMMXT)
#define HAVE_vec_iwmmxt_tinsrb (TARGET_REALLY_IWMMXT)
#define HAVE_vec_iwmmxt_tinsrh (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_extractv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_extractv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_extractv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_reduc_uplus_v2si_iwmmxt_internal (TARGET_REALLY_IWMMXT)
#define HAVE_reduc_uplus_v4hi_iwmmxt_internal (TARGET_REALLY_IWMMXT)
#define HAVE_reduc_uplus_v8qi_iwmmxt_internal (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_shl_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_shl_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_shl_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_shr_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_shr_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_shr_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_vec_wunpckihh (TARGET_REALLY_IWMMXT)
#define HAVE_vec_wunpckilh (TARGET_REALLY_IWMMXT)
#define HAVE_wusumv8qi3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_wusumv4hi3_iwmmxt (TARGET_REALLY_IWMMXT)
#define HAVE_udot_prodv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_nandv2si3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_nandv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_nandv8qi3 (TARGET_REALLY_IWMMXT)
#define HAVE_vec_walignrv2si (TARGET_REALLY_IWMMXT)
#define HAVE_vec_walignrv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_vec_walignrv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_vec_waligniv2si (TARGET_REALLY_IWMMXT)
#define HAVE_vec_waligniv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_vec_waligniv8qi (TARGET_REALLY_IWMMXT)
...
#define HAVE_nop 1
#define HAVE_movcond (TARGET_ARM && !TARGET_NO_COND_EXEC)
...
#define HAVE_vec_concatv16qiv8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatv8hiv4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatv4siv2si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatv4sfv2sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concattiv8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concattiv4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concattiv2si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concattiv2sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatoiv16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatoiv8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatoiv4si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatoiv4sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatoiv2di (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatoiti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatxioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concateiv8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concateiv4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concateiv2si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concateiv2sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatciv16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatciv8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatciv4si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_concatciv4sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv8qiv16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv4hiv8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv2siv4si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv2sfv4sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv8qiti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv4hiti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv2siti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv2sfti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv16qioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv8hioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv4sioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv4sfoi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfv2dioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halftioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_get_halfoixi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv2si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv2sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv4si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_extract_structv4sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv2si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv2sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv4si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_rgb_convertv4sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
...
#define HAVE_neon_vec_extractv8qi (TARGET_NEON)
#define HAVE_neon_vec_extractv4hi (TARGET_NEON)
#define HAVE_neon_vec_extractv2si (TARGET_NEON)
#define HAVE_neon_vec_extractv2sf (TARGET_NEON)
#define HAVE_neon_vec_extractv16qi (TARGET_NEON)
#define HAVE_neon_vec_extractv8hi (TARGET_NEON)
#define HAVE_neon_vec_extractv4si (TARGET_NEON)
#define HAVE_neon_vec_extractv4sf (TARGET_NEON)
#define HAVE_neon_vec_extractv2di (TARGET_NEON)
...
#define HAVE_floatv2siv2sf2 (TARGET_NEON)
#define HAVE_floatv4siv4sf2 (TARGET_NEON)
#define HAVE_floatunsv2siv2sf2 (TARGET_NEON)
#define HAVE_floatunsv4siv4sf2 (TARGET_NEON)
#define HAVE_adddi3_neon (TARGET_NEON)
#define HAVE_subdi3_neon (TARGET_NEON)
#define HAVE_fused_mulv2sf3addv2sf_neon (TARGET_NEON && TARGET_MARVELL_FUSED_MAC)
#define HAVE_fused_mulv4sf3addv4sf_neon (TARGET_NEON && TARGET_MARVELL_FUSED_MAC)
...
#define HAVE_fused_mulv2sf3negv2sfaddv2sf_neon (TARGET_NEON && TARGET_MARVELL_FUSED_MAC)
#define HAVE_fused_mulv4sf3negv4sfaddv4sf_neon (TARGET_NEON && TARGET_MARVELL_FUSED_MAC)
...
#define HAVE_neon_widen_usumv4hi3 (TARGET_NEON)
#define HAVE_neon_widen_usumv8qi3 (TARGET_NEON)
#define HAVE_neon_widen_usumv8hi3 (TARGET_NEON)
#define HAVE_neon_widen_usumv16qi3 (TARGET_NEON)
...
#define HAVE_neon_reduc_splus_v2di (!BYTES_BIG_ENDIAN && TARGET_NEON)
...
#define HAVE_neon_vmovn_v8hi (TARGET_NEON)
#define HAVE_neon_vmovn_v4si (TARGET_NEON)
#define HAVE_neon_vmovn_v2di (TARGET_NEON)
...
#define HAVE_iwmmxt_vec_initv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_initv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_initv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_movv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_movv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_movv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_setv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_setv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_setv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_extract_evenv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_extract_oddv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_interleave_highv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_interleave_highv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_interleave_highv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_interleave_lowv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_interleave_lowv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_interleave_lowv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_uplus_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_uplus_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_uplus_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_splus_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_splus_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_splus_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_smin_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_smax_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_umax_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_reduc_umin_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_vec_pack_ssat_di (TARGET_REALLY_IWMMXT)
#define HAVE_vec_pack_ssat_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_vec_pack_ssat_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_vec_pack_usat_di (TARGET_REALLY_IWMMXT)
#define HAVE_vec_pack_usat_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_vec_pack_usat_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacks_hi_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacks_hi_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacks_hi_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacks_lo_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacks_lo_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacks_lo_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacku_lo_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacku_lo_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacku_lo_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacku_hi_v2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacku_hi_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_unpacku_hi_v8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_widen_smult_hi_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_widen_smult_lo_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_widen_umult_hi_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vec_widen_umult_lo_v4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_absv2si2 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_absv4hi2 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_absv8qi2 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_ashlv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_ashlv2si3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_ashrv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_ashrv2si3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_lshrv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_lshrv2si3 (TARGET_REALLY_IWMMXT)
#define HAVE_rotrv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_rotrv2si3 (TARGET_REALLY_IWMMXT)
#define HAVE_wzero_iwmmxtv2si (TARGET_REALLY_IWMMXT)
#define HAVE_wzero_iwmmxtv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_wzero_iwmmxtv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_widen_usum_dv8qi3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_widen_usumv8qi3 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_widen_usumv4hi3 (TARGET_REALLY_IWMMXT)
#define HAVE_sdot_prodv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_negv2si2 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_negv4hi2 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_negv8qi2 (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vcondv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vcondv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vcondv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vconduv2si (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vconduv4hi (TARGET_REALLY_IWMMXT)
#define HAVE_iwmmxt_vconduv8qi (TARGET_REALLY_IWMMXT)
#define HAVE_vec_realign_load_v2si (TARGET_REALLY_IWMMXT  \
  && (iwmmxt_use_realign  \
      || iwmmxt_use_aggressive_realign))
#define HAVE_vec_realign_load_v4hi (TARGET_REALLY_IWMMXT  \
  && (iwmmxt_use_realign  \
      || iwmmxt_use_aggressive_realign))
#define HAVE_vec_realign_load_v8qi (TARGET_REALLY_IWMMXT  \
  && (iwmmxt_use_realign  \
      || iwmmxt_use_aggressive_realign))
...
#define HAVE_umaxsi3 (TARGET_32BIT && !TARGET_NO_COND_EXEC)
#define HAVE_uminsi3 (TARGET_32BIT && !TARGET_NO_COND_EXEC)
...
#define HAVE_divsi3 (TARGET_32BIT && (target_marvell_div || TARGET_IDIV))
#define HAVE_udivsi3 (TARGET_32BIT && (target_marvell_div || TARGET_IDIV))
...
#define HAVE_cstore_cc (TARGET_32BIT && !TARGET_NO_COND_EXEC)
#define HAVE_cstoresi4 ((TARGET_32BIT && !TARGET_NO_COND_EXEC) || TARGET_THUMB1)
#define HAVE_cstoresf4 (TARGET_32BIT && TARGET_HARD_FLOAT && !TARGET_NO_COND_EXEC)
#define HAVE_cstoredf4 (TARGET_32BIT && TARGET_HARD_FLOAT && !TARGET_VFP_SINGLE && !TARGET_NO_COND_EXEC)
#define HAVE_cstoredi4 (TARGET_32BIT && !TARGET_NO_COND_EXEC)
#define HAVE_cstoresi_eq0_thumb1 (TARGET_THUMB1)
#define HAVE_cstoresi_ne0_thumb1 (TARGET_THUMB1)
#define HAVE_movsicc (TARGET_32BIT && !TARGET_NO_COND_EXEC)
#define HAVE_movsfcc (TARGET_32BIT && TARGET_HARD_FLOAT && !TARGET_NO_COND_EXEC)
#define HAVE_movdfcc (TARGET_32BIT && TARGET_HARD_FLOAT && (TARGET_FPA || TARGET_VFP_DOUBLE) && !TARGET_NO_COND_EXEC)
#define HAVE_jump 1
#define HAVE_call 1
...
#define HAVE_vec_setv4sf (TARGET_NEON \
    || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SFmode)))
#define HAVE_reduc_umax_v2si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V2SImode == V2SImode)))
#define HAVE_reduc_umax_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4HImode == V2SImode)))
#define HAVE_reduc_umax_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8QImode == V2SImode)))
#define HAVE_reduc_umax_v4si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4SImode == V2SImode)))
#define HAVE_reduc_umax_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8HImode == V2SImode)))
#define HAVE_reduc_umax_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V16QImode == V2SImode)))
#define HAVE_reduc_umin_v2si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V2SImode == V2SImode)))
#define HAVE_reduc_umin_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4HImode == V2SImode)))
#define HAVE_reduc_umin_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8QImode == V2SImode)))
#define HAVE_reduc_umin_v4si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4SImode == V2SImode)))
#define HAVE_reduc_umin_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8HImode == V2SImode)))
#define HAVE_reduc_umin_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V16QImode == V2SImode)))
#define HAVE_reduc_smin_v2si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V2SImode == V2SImode)))
#define HAVE_reduc_smin_v4hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V4HImode == V2SImode)))
#define HAVE_reduc_smin_v8qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V8QImode == V2SImode)))
#define HAVE_reduc_smin_v2sf (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V2SFmode == V2SImode)))
#define HAVE_reduc_smin_v4si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V4SImode == V2SImode)))
#define HAVE_reduc_smin_v8hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V8HImode == V2SImode)))
#define HAVE_reduc_smin_v16qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V16QImode == V2SImode)))
#define HAVE_reduc_smin_v4sf (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && V4SFmode == V2SImode)))
#define HAVE_reduc_smax_v2si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V2SImode == V2SImode)))
#define HAVE_reduc_smax_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4HImode == V2SImode)))
#define HAVE_reduc_smax_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8QImode == V2SImode)))
#define HAVE_reduc_smax_v2sf (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V2SFmode == V2SImode)))
#define HAVE_reduc_smax_v4si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4SImode == V2SImode)))
#define HAVE_reduc_smax_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8HImode == V2SImode)))
#define HAVE_reduc_smax_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V16QImode == V2SImode)))
#define HAVE_reduc_smax_v4sf (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4SFmode == V2SImode)))
#define HAVE_vec_shl_v2di (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2DImode))))
#define HAVE_vec_shl_v2si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SImode))))
#define HAVE_vec_shl_v4hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_vec_shl_v8qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_vec_shl_v2sf (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SFmode))))
#define HAVE_vec_shl_v4si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SImode))))
#define HAVE_vec_shl_v8hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_vec_shl_v16qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_vec_shl_v4sf (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SFmode))))
#define HAVE_vec_shr_v2di (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2DImode))))
#define HAVE_vec_shr_v2si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SImode))))
#define HAVE_vec_shr_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_vec_shr_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_vec_shr_v2sf (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SFmode))))
#define HAVE_vec_shr_v4si (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SImode))))
#define HAVE_vec_shr_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_vec_shr_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_vec_shr_v4sf (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SFmode))))
#define HAVE_vec_unpacku_lo_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_vec_unpacku_lo_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_vec_unpacku_lo_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_vec_unpacku_lo_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_vec_unpacks_lo_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_vec_unpacks_lo_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_vec_unpacks_lo_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_vec_unpacks_lo_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_vec_unpacku_hi_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_vec_unpacku_hi_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_vec_unpacku_hi_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_vec_unpacku_hi_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_vec_unpacks_hi_v8qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_vec_unpacks_hi_v4hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_vec_unpacks_hi_v16qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_vec_unpacks_hi_v8hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_widen_usumv8qi3 (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && (V8QImode == V4HImode || V8QImode == V8QImode)))
#define HAVE_widen_usumv4hi3 (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && (V4HImode == V4HImode || V4HImode == V8QImode)))
#define HAVE_widen_usumv16qi3 (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && (V16QImode == V4HImode || V16QImode == V8QImode)))
#define HAVE_widen_usumv8hi3 (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && (V8HImode == V4HImode || V8HImode == V8QImode)))
#define HAVE_widen_usum_dv8qi3 (TARGET_NEON || TARGET_REALLY_IWMMXT)
#define HAVE_vec_widen_umult_hi_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8QImode == V4HImode)))
#define HAVE_vec_widen_umult_hi_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4HImode == V4HImode)))
#define HAVE_vec_widen_umult_hi_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V16QImode == V4HImode)))
#define HAVE_vec_widen_umult_hi_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8HImode == V4HImode)))
#define HAVE_vec_widen_smult_hi_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && V8QImode == V4HImode)))
#define HAVE_vec_widen_smult_hi_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && V4HImode == V4HImode)))
#define HAVE_vec_widen_smult_hi_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && V16QImode == V4HImode)))
#define HAVE_vec_widen_smult_hi_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && V8HImode == V4HImode)))
#define HAVE_vec_widen_umult_lo_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8QImode == V4HImode)))
#define HAVE_vec_widen_umult_lo_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4HImode == V4HImode)))
#define HAVE_vec_widen_umult_lo_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V16QImode == V4HImode)))
#define HAVE_vec_widen_umult_lo_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8HImode == V4HImode)))
#define HAVE_vec_widen_smult_lo_v8qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8QImode == V4HImode)))
#define HAVE_vec_widen_smult_lo_v4hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V4HImode == V4HImode)))
#define HAVE_vec_widen_smult_lo_v16qi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V16QImode == V4HImode)))
#define HAVE_vec_widen_smult_lo_v8hi (!BYTES_BIG_ENDIAN \
   && (TARGET_NEON \
       || (TARGET_REALLY_IWMMXT && V8HImode == V4HImode)))
...
#define HAVE_vec_extractv4sf (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SFmode)))
#define HAVE_reduc_uplus_v2di (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2DImode))))
#define HAVE_reduc_uplus_v2si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SImode))))
#define HAVE_reduc_uplus_v4hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_reduc_uplus_v8qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_reduc_uplus_v4si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SImode))))
#define HAVE_reduc_uplus_v8hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_reduc_uplus_v16qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
#define HAVE_reduc_splus_v2di (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2DImode))))
#define HAVE_reduc_splus_v2si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SImode))))
#define HAVE_reduc_splus_v4hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))))
#define HAVE_reduc_splus_v8qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))))
#define HAVE_reduc_splus_v4si (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SImode))))
#define HAVE_reduc_splus_v8hi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))))
#define HAVE_reduc_splus_v16qi (!BYTES_BIG_ENDIAN \
    && (TARGET_NEON \
        || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))))
...
#define HAVE_vconduv16qi (TARGET_NEON \
   || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode)))
#define HAVE_ashlv2si3 ((TARGET_REALLY_IWMMXT &&  (V2SImode == V4HImode || V2SImode == V2SImode)))
#define HAVE_ashlv4hi3 ((TARGET_REALLY_IWMMXT &&  (V4HImode == V4HImode || V4HImode == V2SImode)))
#define HAVE_ashrv2si3 ((TARGET_REALLY_IWMMXT &&  (V2SImode == V4HImode || V2SImode == V2SImode)))
#define HAVE_ashrv4hi3 ((TARGET_REALLY_IWMMXT &&  (V4HImode == V4HImode || V4HImode == V2SImode)))
#define HAVE_lshrv2si3 ((TARGET_REALLY_IWMMXT &&  (V2SImode == V4HImode || V2SImode == V2SImode)))
#define HAVE_lshrv4hi3 ((TARGET_REALLY_IWMMXT &&  (V4HImode == V4HImode || V4HImode == V2SImode)))
#define HAVE_vec_interleave_highv2si (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SImode))
#define HAVE_vec_interleave_highv4hi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))
#define HAVE_vec_interleave_highv8qi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))
#define HAVE_vec_interleave_highv2sf (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SFmode))
#define HAVE_vec_interleave_highv4si (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SImode))
#define HAVE_vec_interleave_highv8hi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))
#define HAVE_vec_interleave_highv16qi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))
#define HAVE_vec_interleave_highv4sf (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SFmode))
#define HAVE_vec_interleave_lowv2si (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SImode))
#define HAVE_vec_interleave_lowv4hi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4HImode))
#define HAVE_vec_interleave_lowv8qi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8QImode))
#define HAVE_vec_interleave_lowv2sf (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V2SFmode))
#define HAVE_vec_interleave_lowv4si (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SImode))
#define HAVE_vec_interleave_lowv8hi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V8HImode))
#define HAVE_vec_interleave_lowv16qi (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V16QImode))
#define HAVE_vec_interleave_lowv4sf (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE (V4SFmode))
#define HAVE_vec_extract_evenv2si (TARGET_REALLY_IWMMXT && V2SImode == V2SImode)
#define HAVE_vec_extract_oddv2si ((TARGET_REALLY_IWMMXT && V2SImode == V2SImode))
...
#define HAVE_vec_get_partv8qiv16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4hiv8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2siv4si (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2sfv4sf (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv8qiti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4hiti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2siti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2sfti (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv16qioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv8hioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4sioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4sfoi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2dioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_parttioi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partoixi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv8qiei (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4hiei (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2siei (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv2sfei (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv16qici (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv8hici (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4sici (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_vec_get_partv4sfci (TARGET_NEON && !BYTES_BIG_ENDIAN)
...
#define HAVE_neon_vec_setv8qi (TARGET_NEON)
#define HAVE_neon_vec_setv16qi (TARGET_NEON)
#define HAVE_neon_vec_setv4hi (TARGET_NEON)
#define HAVE_neon_vec_setv8hi (TARGET_NEON)
#define HAVE_neon_vec_setv2si (TARGET_NEON)
#define HAVE_neon_vec_setv4si (TARGET_NEON)
#define HAVE_neon_vec_setv2sf (TARGET_NEON)
#define HAVE_neon_vec_setv4sf (TARGET_NEON)
#define HAVE_neon_vec_setv2di (TARGET_NEON)
#define HAVE_neon_vec_initv8qi (TARGET_NEON)
#define HAVE_neon_vec_initv16qi (TARGET_NEON)
#define HAVE_neon_vec_initv4hi (TARGET_NEON)
#define HAVE_neon_vec_initv8hi (TARGET_NEON)
#define HAVE_neon_vec_initv2si (TARGET_NEON)
#define HAVE_neon_vec_initv4si (TARGET_NEON)
#define HAVE_neon_vec_initv2sf (TARGET_NEON)
#define HAVE_neon_vec_initv4sf (TARGET_NEON)
#define HAVE_neon_vec_initv2di (TARGET_NEON)
...
#define HAVE_widen_ssum_dv8qi3 (TARGET_NEON)
#define HAVE_widen_ssum_dv16qi3 (TARGET_NEON)
#define HAVE_neon_widen_usum_dv8qi3 (TARGET_NEON)
#define HAVE_widen_usum_dv16qi3 (TARGET_NEON)
#define HAVE_neon_vec_shr_v8qi (TARGET_NEON)
#define HAVE_neon_vec_shr_v16qi (TARGET_NEON)
#define HAVE_neon_vec_shr_v4hi (TARGET_NEON)
#define HAVE_neon_vec_shr_v8hi (TARGET_NEON)
#define HAVE_neon_vec_shr_v2si (TARGET_NEON)
#define HAVE_neon_vec_shr_v4si (TARGET_NEON)
#define HAVE_neon_vec_shr_v2sf (TARGET_NEON)
#define HAVE_neon_vec_shr_v4sf (TARGET_NEON)
#define HAVE_neon_vec_shr_v2di (TARGET_NEON)
#define HAVE_neon_vec_shl_v8qi (TARGET_NEON)
#define HAVE_neon_vec_shl_v16qi (TARGET_NEON)
#define HAVE_neon_vec_shl_v4hi (TARGET_NEON)
#define HAVE_neon_vec_shl_v8hi (TARGET_NEON)
#define HAVE_neon_vec_shl_v2si (TARGET_NEON)
#define HAVE_neon_vec_shl_v4si (TARGET_NEON)
#define HAVE_neon_vec_shl_v2sf (TARGET_NEON)
#define HAVE_neon_vec_shl_v4sf (TARGET_NEON)
#define HAVE_neon_vec_shl_v2di (TARGET_NEON)
...
#define HAVE_neon_reduc_splus_v8qi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v4hi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v2si (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v2sf (!BYTES_BIG_ENDIAN && TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v16qi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v8hi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v4si (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_splus_v4sf (!BYTES_BIG_ENDIAN && TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_uplus_v8qi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_uplus_v16qi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_uplus_v4hi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_uplus_v8hi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_uplus_v2si (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_uplus_v4si (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_uplus_v2di (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_smin_v8qi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v4hi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v2si (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v2sf (!BYTES_BIG_ENDIAN && TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v16qi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v8hi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v4si (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smin_v4sf (!BYTES_BIG_ENDIAN && TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v8qi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v4hi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v2si (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v2sf (!BYTES_BIG_ENDIAN && TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v16qi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v8hi (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v4si (!BYTES_BIG_ENDIAN && TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_smax_v4sf (!BYTES_BIG_ENDIAN && TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_reduc_umin_v8qi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umin_v4hi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umin_v2si (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umin_v16qi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umin_v8hi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umin_v4si (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umax_v8qi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umax_v4hi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umax_v2si (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umax_v16qi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umax_v8hi (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_neon_reduc_umax_v4si (!BYTES_BIG_ENDIAN && TARGET_NEON)
#define HAVE_divv2sf3 (TARGET_NEON && flag_unsafe_math_optimizations)
#define HAVE_divv4sf3 (TARGET_NEON && flag_unsafe_math_optimizations)
#define HAVE_neon_vcondv8qi (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv16qi (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv4hi (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv8hi (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv2si (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv4si (TARGET_NEON && (!false || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv2sf (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_vcondv4sf (TARGET_NEON && (!true || flag_unsafe_math_optimizations))
#define HAVE_neon_vconduv8qi (TARGET_NEON)
#define HAVE_neon_vconduv16qi (TARGET_NEON)
#define HAVE_neon_vconduv4hi (TARGET_NEON)
#define HAVE_neon_vconduv8hi (TARGET_NEON)
#define HAVE_neon_vconduv2si (TARGET_NEON)
#define HAVE_neon_vconduv4si (TARGET_NEON)
...
#define HAVE_neon_vec_widen_umult_lo_v16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_lo_v8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_hi_v16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_hi_v8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_lo_v16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_lo_v8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_hi_v16qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_hi_v8hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_lo_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_lo_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_hi_v8qi (TARGET_NEON  && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_umult_hi_v4hi (TARGET_NEON  && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_lo_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_lo_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_hi_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_widen_smult_hi_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
...
#define HAVE_neon_vec_unpacku_lo_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacku_lo_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacku_hi_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacku_hi_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacks_lo_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacks_lo_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacks_hi_v8qi (TARGET_NEON && !BYTES_BIG_ENDIAN)
#define HAVE_neon_vec_unpacks_hi_v4hi (TARGET_NEON && !BYTES_BIG_ENDIAN)
...
extern rtx        gen_roriv4hi3                         (rtx, rtx, rtx);
extern rtx        gen_roriv2si3                         (rtx, rtx, rtx);
extern rtx        gen_roridi3                           (rtx, rtx, rtx);
...
extern rtx        gen_ashriv4hi3_iwmmxt                 (rtx, rtx, rtx);
extern rtx        gen_ashriv2si3_iwmmxt                 (rtx, rtx, rtx);
extern rtx        gen_ashridi3_iwmmxt                   (rtx, rtx, rtx);
...
extern rtx        gen_lshriv4hi3_iwmmxt                 (rtx, rtx, rtx);
extern rtx        gen_lshriv2si3_iwmmxt                 (rtx, rtx, rtx);
extern rtx        gen_lshridi3_iwmmxt                   (rtx, rtx, rtx);
...
extern rtx        gen_ashliv4hi3_iwmmxt                 (rtx, rtx, rtx);
extern rtx        gen_ashliv2si3_iwmmxt                 (rtx, rtx, rtx);
extern rtx        gen_ashlidi3_iwmmxt                   (rtx, rtx, rtx);
...
extern rtx        gen_iwmmxt_movv2si_yrr                (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_movv4hi_yrr                (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_movv8qi_yrr                (rtx, rtx, rtx);
extern rtx        gen_vec_iwmmxt_tinsrb                 (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_iwmmxt_tinsrh                 (rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_extractv2si            (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_extractv4hi            (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_extractv8qi            (rtx, rtx, rtx);
extern rtx        gen_reduc_uplus_v2si_iwmmxt_internal  (rtx, rtx);
extern rtx        gen_reduc_uplus_v4hi_iwmmxt_internal  (rtx, rtx);
extern rtx        gen_reduc_uplus_v8qi_iwmmxt_internal  (rtx, rtx);
extern rtx        gen_iwmmxt_vec_shl_v2si               (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_shl_v4hi               (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_shl_v8qi               (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_shr_v2si               (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_shr_v4hi               (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_shr_v8qi               (rtx, rtx, rtx);
extern rtx        gen_vec_wunpckihh                     (rtx, rtx, rtx);
extern rtx        gen_vec_wunpckilh                     (rtx, rtx, rtx);
extern rtx        gen_wusumv8qi3_iwmmxt                 (rtx, rtx);
extern rtx        gen_wusumv4hi3_iwmmxt                 (rtx, rtx);
extern rtx        gen_udot_prodv4hi                     (rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_nandv2si3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_nandv4hi3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_nandv8qi3                  (rtx, rtx, rtx);
extern rtx        gen_vec_walignrv2si                   (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_walignrv4hi                   (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_walignrv8qi                   (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_waligniv2si                   (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_waligniv4hi                   (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_waligniv8qi                   (rtx, rtx, rtx, rtx);
...
extern rtx        gen_vec_concatv16qiv8qi               (rtx, rtx, rtx);
extern rtx        gen_vec_concatv8hiv4hi                (rtx, rtx, rtx);
extern rtx        gen_vec_concatv4siv2si                (rtx, rtx, rtx);
extern rtx        gen_vec_concatv4sfv2sf                (rtx, rtx, rtx);
extern rtx        gen_vec_concattiv8qi                  (rtx, rtx, rtx);
extern rtx        gen_vec_concattiv4hi                  (rtx, rtx, rtx);
extern rtx        gen_vec_concattiv2si                  (rtx, rtx, rtx);
extern rtx        gen_vec_concattiv2sf                  (rtx, rtx, rtx);
extern rtx        gen_vec_concatoiv16qi                 (rtx, rtx, rtx);
extern rtx        gen_vec_concatoiv8hi                  (rtx, rtx, rtx);
extern rtx        gen_vec_concatoiv4si                  (rtx, rtx, rtx);
extern rtx        gen_vec_concatoiv4sf                  (rtx, rtx, rtx);
extern rtx        gen_vec_concatoiv2di                  (rtx, rtx, rtx);
extern rtx        gen_vec_concatoiti                    (rtx, rtx, rtx);
extern rtx        gen_vec_concatxioi                    (rtx, rtx, rtx);
extern rtx        gen_vec_concateiv8qi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concateiv4hi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concateiv2si                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concateiv2sf                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concatciv16qi                 (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concatciv8hi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concatciv4si                  (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_concatciv4sf                  (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv8qiv16qi        (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv4hiv8hi         (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv2siv4si         (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv2sfv4sf         (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv8qiti           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv4hiti           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv2siti           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv2sfti           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv16qioi          (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv8hioi           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv4sioi           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv4sfoi           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfv2dioi           (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halftioi             (rtx, rtx, rtx);
extern rtx        gen_neon_vec_get_halfoixi             (rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv8qi           (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv4hi           (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv2si           (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv2sf           (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv16qi          (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv8hi           (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv4si           (rtx, rtx, rtx, rtx);
extern rtx        gen_neon_extract_structv4sf           (rtx, rtx, rtx, rtx);
extern rtx        gen_rgb_convertv8qi                   (rtx, rtx);
extern rtx        gen_rgb_convertv4hi                   (rtx, rtx);
extern rtx        gen_rgb_convertv2si                   (rtx, rtx);
extern rtx        gen_rgb_convertv2sf                   (rtx, rtx);
extern rtx        gen_rgb_convertv16qi                  (rtx, rtx);
extern rtx        gen_rgb_convertv8hi                   (rtx, rtx);
extern rtx        gen_rgb_convertv4si                   (rtx, rtx);
extern rtx        gen_rgb_convertv4sf                   (rtx, rtx);
...
extern rtx        gen_neon_vec_extractv8qi              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv4hi              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv2si              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv2sf              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv16qi             (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv8hi              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv4si              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv4sf              (rtx, rtx, rtx);
extern rtx        gen_neon_vec_extractv2di              (rtx, rtx, rtx);
...
extern rtx        gen_fused_mulv2sf3addv2sf_neon        (rtx, rtx, rtx, rtx);
extern rtx        gen_fused_mulv4sf3addv4sf_neon        (rtx, rtx, rtx, rtx);
...
extern rtx        gen_fused_mulv2sf3negv2sfaddv2sf_neon (rtx, rtx, rtx, rtx);
extern rtx        gen_fused_mulv4sf3negv4sfaddv4sf_neon (rtx, rtx, rtx, rtx);
...
extern rtx        gen_neon_widen_usumv4hi3              (rtx, rtx, rtx);
extern rtx        gen_neon_widen_usumv8qi3              (rtx, rtx, rtx);
extern rtx        gen_neon_widen_usumv8hi3              (rtx, rtx, rtx);
extern rtx        gen_neon_widen_usumv16qi3             (rtx, rtx, rtx);
...
extern rtx        gen_neon_reduc_splus_v2di             (rtx, rtx);
...
extern rtx        gen_neon_vmovn_v8hi                   (rtx, rtx);
extern rtx        gen_neon_vmovn_v4si                   (rtx, rtx);
extern rtx        gen_neon_vmovn_v2di                   (rtx, rtx);
...
extern rtx        gen_iwmmxt_vec_initv2si               (rtx, rtx);
extern rtx        gen_iwmmxt_vec_initv4hi               (rtx, rtx);
extern rtx        gen_iwmmxt_vec_initv8qi               (rtx, rtx);
extern rtx        gen_iwmmxt_movv2si                    (rtx, rtx);
extern rtx        gen_iwmmxt_movv4hi                    (rtx, rtx);
extern rtx        gen_iwmmxt_movv8qi                    (rtx, rtx);
extern rtx        gen_iwmmxt_vec_setv2si                (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_setv4hi                (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_setv8qi                (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_extract_evenv2si       (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_extract_oddv2si        (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_interleave_highv2si    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_interleave_highv4hi    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_interleave_highv8qi    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_interleave_lowv2si     (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_interleave_lowv4hi     (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_interleave_lowv8qi     (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_reduc_uplus_v2si           (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_uplus_v4hi           (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_uplus_v8qi           (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_splus_v2si           (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_splus_v4hi           (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_splus_v8qi           (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_smin_v2si            (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_smax_v2si            (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_umax_v2si            (rtx, rtx);
extern rtx        gen_iwmmxt_reduc_umin_v2si            (rtx, rtx);
extern rtx        gen_vec_pack_ssat_di                  (rtx, rtx, rtx);
extern rtx        gen_vec_pack_ssat_v2si                (rtx, rtx, rtx);
extern rtx        gen_vec_pack_ssat_v4hi                (rtx, rtx, rtx);
extern rtx        gen_vec_pack_usat_di                  (rtx, rtx, rtx);
extern rtx        gen_vec_pack_usat_v2si                (rtx, rtx, rtx);
extern rtx        gen_vec_pack_usat_v4hi                (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacks_hi_v2si        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacks_hi_v4hi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacks_hi_v8qi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacks_lo_v2si        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacks_lo_v4hi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacks_lo_v8qi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacku_lo_v2si        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacku_lo_v4hi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacku_lo_v8qi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacku_hi_v2si        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacku_hi_v4hi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_unpacku_hi_v8qi        (rtx, rtx);
extern rtx        gen_iwmmxt_vec_widen_smult_hi_v4hi    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_widen_smult_lo_v4hi    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_widen_umult_hi_v4hi    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vec_widen_umult_lo_v4hi    (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_absv2si2                   (rtx, rtx);
extern rtx        gen_iwmmxt_absv4hi2                   (rtx, rtx);
extern rtx        gen_iwmmxt_absv8qi2                   (rtx, rtx);
extern rtx        gen_iwmmxt_ashlv4hi3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_ashlv2si3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_ashrv4hi3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_ashrv2si3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_lshrv4hi3                  (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_lshrv2si3                  (rtx, rtx, rtx);
extern rtx        gen_rotrv4hi3                         (rtx, rtx, rtx);
extern rtx        gen_rotrv2si3                         (rtx, rtx, rtx);
extern rtx        gen_wzero_iwmmxtv2si                  (rtx);
extern rtx        gen_wzero_iwmmxtv4hi                  (rtx);
extern rtx        gen_wzero_iwmmxtv8qi                  (rtx);
extern rtx        gen_iwmmxt_widen_usum_dv8qi3          (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_widen_usumv8qi3            (rtx, rtx, rtx);
extern rtx        gen_iwmmxt_widen_usumv4hi3            (rtx, rtx, rtx);
extern rtx        gen_sdot_prodv4hi                     (rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_negv2si2                   (rtx, rtx);
extern rtx        gen_iwmmxt_negv4hi2                   (rtx, rtx);
extern rtx        gen_iwmmxt_negv8qi2                   (rtx, rtx);
extern rtx        gen_iwmmxt_vcondv2si                  (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vcondv4hi                  (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vcondv8qi                  (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vconduv2si                 (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vconduv4hi                 (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_iwmmxt_vconduv8qi                 (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_vec_realign_load_v2si             (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_realign_load_v4hi             (rtx, rtx, rtx, rtx);
extern rtx        gen_vec_realign_load_v8qi             (rtx, rtx, rtx, rtx);
...
extern rtx        gen_widen_usum_dv8qi3                 (rtx, rtx, rtx);
...
static inline rtx gen_ashlv4si3                         (rtx, rtx, rtx);
static inline rtx
gen_ashlv4si3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ashlv8hi3                         (rtx, rtx, rtx);
static inline rtx
gen_ashlv8hi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ashlv16qi3                        (rtx, rtx, rtx);
static inline rtx
gen_ashlv16qi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_ashrv4si3                         (rtx, rtx, rtx);
static inline rtx
gen_ashrv4si3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ashrv8hi3                         (rtx, rtx, rtx);
static inline rtx
gen_ashrv8hi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_ashrv16qi3                        (rtx, rtx, rtx);
static inline rtx
gen_ashrv16qi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_lshrv4si3                         (rtx, rtx, rtx);
static inline rtx
gen_lshrv4si3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_lshrv8hi3                         (rtx, rtx, rtx);
static inline rtx
gen_lshrv8hi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_lshrv16qi3                        (rtx, rtx, rtx);
static inline rtx
gen_lshrv16qi3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_vec_extract_evenv2si              (rtx, rtx, rtx);
static inline rtx gen_vec_extract_evenv4hi              (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_evenv4hi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_evenv8qi              (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_evenv8qi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_vec_extract_evenv4si              (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_evenv4si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_evenv8hi              (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_evenv8hi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_evenv16qi             (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_evenv16qi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_evenv4sf              (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_evenv4sf(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_vec_extract_oddv2si               (rtx, rtx, rtx);
static inline rtx gen_vec_extract_oddv4hi               (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_oddv4hi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_oddv8qi               (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_oddv8qi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
static inline rtx gen_vec_extract_oddv4si               (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_oddv4si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_oddv8hi               (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_oddv8hi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_oddv16qi              (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_oddv16qi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_vec_extract_oddv4sf               (rtx, rtx, rtx);
static inline rtx
gen_vec_extract_oddv4sf(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_vec_get_partv8qiv16qi             (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4hiv8hi              (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2siv4si              (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2sfv4sf              (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv8qiti                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4hiti                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2siti                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2sfti                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv16qioi               (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv8hioi                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4sioi                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4sfoi                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2dioi                (rtx, rtx, rtx);
extern rtx        gen_vec_get_parttioi                  (rtx, rtx, rtx);
extern rtx        gen_vec_get_partoixi                  (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv8qiei                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4hiei                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2siei                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv2sfei                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv16qici               (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv8hici                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4sici                (rtx, rtx, rtx);
extern rtx        gen_vec_get_partv4sfci                (rtx, rtx, rtx);
...
extern rtx        gen_neon_vec_setv8qi                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv16qi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv4hi                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv8hi                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv2si                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv4si                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv2sf                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv4sf                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_setv2di                  (rtx, rtx, rtx);
extern rtx        gen_neon_vec_initv8qi                 (rtx, rtx);
extern rtx        gen_neon_vec_initv16qi                (rtx, rtx);
extern rtx        gen_neon_vec_initv4hi                 (rtx, rtx);
extern rtx        gen_neon_vec_initv8hi                 (rtx, rtx);
extern rtx        gen_neon_vec_initv2si                 (rtx, rtx);
extern rtx        gen_neon_vec_initv4si                 (rtx, rtx);
extern rtx        gen_neon_vec_initv2sf                 (rtx, rtx);
extern rtx        gen_neon_vec_initv4sf                 (rtx, rtx);
extern rtx        gen_neon_vec_initv2di                 (rtx, rtx);
...
extern rtx        gen_widen_ssum_dv8qi3                 (rtx, rtx, rtx);
extern rtx        gen_widen_ssum_dv16qi3                (rtx, rtx, rtx);
extern rtx        gen_neon_widen_usum_dv8qi3            (rtx, rtx, rtx);
extern rtx        gen_widen_usum_dv16qi3                (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v8qi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v16qi                (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v4hi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v8hi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v2si                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v4si                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v2sf                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v4sf                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shr_v2di                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v8qi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v16qi                (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v4hi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v8hi                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v2si                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v4si                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v2sf                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v4sf                 (rtx, rtx, rtx);
extern rtx        gen_neon_vec_shl_v2di                 (rtx, rtx, rtx);
...
extern rtx        gen_neon_reduc_splus_v8qi             (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v4hi             (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v2si             (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v2sf             (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v16qi            (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v8hi             (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v4si             (rtx, rtx);
extern rtx        gen_neon_reduc_splus_v4sf             (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v8qi             (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v16qi            (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v4hi             (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v8hi             (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v2si             (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v4si             (rtx, rtx);
extern rtx        gen_neon_reduc_uplus_v2di             (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v8qi              (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v4hi              (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v2si              (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v2sf              (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v16qi             (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v8hi              (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v4si              (rtx, rtx);
extern rtx        gen_neon_reduc_smin_v4sf              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v8qi              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v4hi              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v2si              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v2sf              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v16qi             (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v8hi              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v4si              (rtx, rtx);
extern rtx        gen_neon_reduc_smax_v4sf              (rtx, rtx);
extern rtx        gen_neon_reduc_umin_v8qi              (rtx, rtx);
extern rtx        gen_neon_reduc_umin_v4hi              (rtx, rtx);
extern rtx        gen_neon_reduc_umin_v2si              (rtx, rtx);
extern rtx        gen_neon_reduc_umin_v16qi             (rtx, rtx);
extern rtx        gen_neon_reduc_umin_v8hi              (rtx, rtx);
extern rtx        gen_neon_reduc_umin_v4si              (rtx, rtx);
extern rtx        gen_neon_reduc_umax_v8qi              (rtx, rtx);
extern rtx        gen_neon_reduc_umax_v4hi              (rtx, rtx);
extern rtx        gen_neon_reduc_umax_v2si              (rtx, rtx);
extern rtx        gen_neon_reduc_umax_v16qi             (rtx, rtx);
extern rtx        gen_neon_reduc_umax_v8hi              (rtx, rtx);
extern rtx        gen_neon_reduc_umax_v4si              (rtx, rtx);
extern rtx        gen_divv2sf3                          (rtx, rtx, rtx);
extern rtx        gen_divv4sf3                          (rtx, rtx, rtx);
extern rtx        gen_neon_vcondv8qi                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv16qi                   (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv4hi                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv8hi                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv2si                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv4si                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv2sf                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vcondv4sf                    (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vconduv8qi                   (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vconduv16qi                  (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vconduv4hi                   (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vconduv8hi                   (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vconduv2si                   (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_neon_vconduv4si                   (rtx, rtx, rtx, rtx, rtx, rtx);
...
extern rtx        gen_neon_vec_widen_umult_lo_v16qi     (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_lo_v8hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_hi_v16qi     (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_hi_v8hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_lo_v16qi     (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_lo_v8hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_hi_v16qi     (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_hi_v8hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_lo_v8qi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_lo_v4hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_hi_v8qi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_umult_hi_v4hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_lo_v8qi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_lo_v4hi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_hi_v8qi      (rtx, rtx, rtx);
extern rtx        gen_neon_vec_widen_smult_hi_v4hi      (rtx, rtx, rtx);
...
extern rtx        gen_neon_vec_unpacku_lo_v16qi         (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_lo_v8hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_hi_v16qi         (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_hi_v8hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_lo_v16qi         (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_lo_v8hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_hi_v16qi         (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_hi_v8hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_lo_v8qi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_lo_v4hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_hi_v8qi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacku_hi_v4hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_lo_v8qi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_lo_v4hi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_hi_v8qi          (rtx, rtx);
extern rtx        gen_neon_vec_unpacks_hi_v4hi          (rtx, rtx);
