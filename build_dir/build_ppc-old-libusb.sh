...
export ARCH=ppc
export target=ppc
export NCAM_BIN=ncam-libusb.ppc-old
export CROSS=$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/bin/powerpc-linux-
export CC=$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/bin/powerpc-linux-gcc
export RANLIB=$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/bin/powerpc-linux-ranlib
export DCMAKE=cross-ppc-tuxbox-linux-libusb
export SCRIPT=build_ppc-old-libusb.sh

export EXTRA_LIBS="-lrt"

export OPENSSLDIR=$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/include/openssl/

export LIB_RT="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/lib/librt.a -lrt"
export LIB_PTHREAD="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/lib/libpthread.a -lrt"
export LIBCRYPT="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/lib/libcrypt.a -lrt"

export LIBCRYPTO="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/lib/libcrypto.a -lrt"
export LIB_SSL="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/lib/libssl.a -lrt"

export LIBUSB_LIB="$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/lib/libusb-1.0.a -lrt"
export LIST_SMARGO=list_smargo-*-powerpc-linux-libusb
export LIST_SMARGO2=list_smargo-*-powerpc-linux-ssl-libusb

export PATH=$PATH:~$ROOTFS_PATH/cross/Toolchain-PPC-Tuxbox-old/bin
