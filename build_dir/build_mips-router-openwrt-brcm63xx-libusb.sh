...
export LIBUSB_LIB="$ROOTFS_PATH/cross/Toolchain-openwrt1505cc/mips-openwrt-linux-uclibc/lib/libusb-1.0.a -lrt"
export LIST_SMARGO=list_smargo-*-mips-openwrt-linux-uclibc-libusb
export LIST_SMARGO2=list_smargo-*-mips-openwrt-linux-uclibc-ssl-libusb
