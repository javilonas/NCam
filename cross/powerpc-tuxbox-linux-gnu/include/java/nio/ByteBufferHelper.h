...
{
private:
  static void checkRemainingForRead (::java::nio::ByteBuffer *, jint);
  static void checkRemainingForWrite (::java::nio::ByteBuffer *, jint);
  static void checkAvailableForRead (::java::nio::ByteBuffer *, jint, jint);
  static void checkAvailableForWrite (::java::nio::ByteBuffer *, jint, jint);
public:
