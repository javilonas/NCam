...
public:  // actually protected
  JArray< ::java::util::prefs::AbstractPreferences *> *cachedChildren ();
public:
...
public:
  ...
  virtual jbyteArray getByteArray (::java::lang::String *, jbyteArray);
private:
  static jbyteArray decode64 (::java::lang::String *);
public:
  ...
  virtual void putByteArray (::java::lang::String *, jbyteArray);
private:
  static ::java::lang::String *encode64 (jbyteArray);
public:
