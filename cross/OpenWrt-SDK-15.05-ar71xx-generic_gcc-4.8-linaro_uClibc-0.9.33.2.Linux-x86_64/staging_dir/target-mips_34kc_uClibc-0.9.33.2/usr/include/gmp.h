...
#define __GMP_CC "mips-openwrt-linux-uclibc-gcc -std=gnu99"
#define __GMP_CFLAGS "-Os -pipe -mno-branch-likely -mips32r2 -mtune=34kc -fno-caller-saves -fhonour-copts -Wno-error=unused-but-set-variable -msoft-float -fpic "
