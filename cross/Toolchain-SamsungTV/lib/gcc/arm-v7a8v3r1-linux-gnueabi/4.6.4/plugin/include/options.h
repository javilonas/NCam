...
#else
  int x_warn_global_constructors;
#define warn_global_constructors global_options.x_warn_global_constructors
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wglobal_constructors = 227,            /* -Wglobal-constructors */
  ...
  OPT_Wnon_template_friend = 271,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 272,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 273,                        /* -Wnonnull */
  OPT_Wnormalized_ = 274,                    /* -Wnormalized= */
  OPT_Wnull = 275,                           /* -Wnull */
  OPT_Wold_style_cast = 276,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 277,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 278,           /* -Wold-style-definition */
  OPT_Wout_of_date = 279,                    /* -Wout-of-date */
  OPT_Wover_ann = 280,                       /* -Wover-ann */
  OPT_Woverflow = 281,                       /* -Woverflow */
  OPT_Woverlength_strings = 282,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 283,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 284,                  /* -Woverride-init */
  OPT_Wp_ = 285,                             /* -Wp, */
  OPT_Wpacked = 286,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 287,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 288,                         /* -Wpadded */
  OPT_Wparam_assign = 289,                   /* -Wparam-assign */
  OPT_Wparentheses = 290,                    /* -Wparentheses */
  OPT_Wpkg_default_method = 291,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 292,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 293,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 294,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 295,            /* -Wpointer-to-int-cast */
  ...
  OPT_falign_commons = 409,                  /* -falign-commons */
  OPT_falign_functions = 410,                /* -falign-functions */
  OPT_falign_functions_ = 411,               /* -falign-functions= */
  OPT_falign_jumps = 412,                    /* -falign-jumps */
  OPT_falign_jumps_ = 413,                   /* -falign-jumps= */
  OPT_falign_labels = 414,                   /* -falign-labels */
  OPT_falign_labels_ = 415,                  /* -falign-labels= */
  OPT_falign_loops = 416,                    /* -falign-loops */
  OPT_falign_loops_ = 417,                   /* -falign-loops= */
  OPT_fall_intrinsics = 418,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 419, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 420,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 421, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 422, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 423, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 424, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 425, */  /* -fargument-noalias-global */
  OPT_fasm = 426,                            /* -fasm */
  ...
  OPT_fira_loop_pressure = 622,              /* -fira-loop-pressure */
  OPT_fira_region_ = 623,                    /* -fira-region= */
  OPT_fira_share_save_slots = 624,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 625,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 626,                   /* -fira-verbose= */
  OPT_fivopts = 627,                         /* -fivopts */
  OPT_fjni = 628,                            /* -fjni */
  OPT_fjump_tables = 629,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 630,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 631,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 632,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 633, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 634,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 635,             /* -fleading-underscore */
  OPT_floop_block = 636,                     /* -floop-block */
  OPT_floop_flatten = 637,                   /* -floop-flatten */
  OPT_floop_interchange = 638,               /* -floop-interchange */
  /* OPT_floop_optimize = 639, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 640,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 641,                /* -floop-strip-mine */
  OPT_flto = 642,                            /* -flto */
  OPT_flto_compression_level_ = 643,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 644,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 645,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 646,             /* -flto-partition=none */
  OPT_flto_report = 647,                     /* -flto-report */
  OPT_flto_ = 648,                           /* -flto= */
  OPT_fltrans = 649,                         /* -fltrans */
  OPT_fltrans_output_list_ = 650,            /* -fltrans-output-list= */
  OPT_fmain_ = 651,                          /* -fmain= */
  OPT_fmath_errno = 652,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 653,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 654,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 655,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 656,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 657,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 658,                     /* -fmem-report */
  OPT_fmerge_all_constants = 659,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 660,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 661,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 662,                /* -fmessage-length= */
  OPT_fmodule_private = 663,                 /* -fmodule-private */
  OPT_fmodulo_sched = 664,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 665,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 666,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 667,                  /* -fms-extensions */
  OPT_fmudflap = 668,                        /* -fmudflap */
  OPT_fmudflapir = 669,                      /* -fmudflapir */
  OPT_fmudflapth = 670,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 671, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 672, */                  /* -fnew-abi */
  OPT_fnext_runtime = 673,                   /* -fnext-runtime */
  OPT_fnil_receivers = 674,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 675,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 676,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 677, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 678,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 679,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 680,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 681,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 682,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 683,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 684,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 685,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 686,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 687,             /* -fomit-frame-pointer */
  OPT_fopenmp = 688,                         /* -fopenmp */
  OPT_foperator_names = 689,                 /* -foperator-names */
  OPT_foptimize_register_move = 690,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 691,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 692,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 693, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 694,              /* -foutput-class-dir= */
  OPT_fpack_derived = 695,                   /* -fpack-derived */
  OPT_fpack_struct = 696,                    /* -fpack-struct */
  OPT_fpack_struct_ = 697,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 698,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 699,              /* -fpcc-struct-return */
  OPT_fpch_deps = 700,                       /* -fpch-deps */
  OPT_fpch_preprocess = 701,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 702,                     /* -fpeel-loops */
  OPT_fpeephole = 703,                       /* -fpeephole */
  OPT_fpeephole2 = 704,                      /* -fpeephole2 */
  OPT_fpermissive = 705,                     /* -fpermissive */
  OPT_fpic = 706,                            /* -fpic */
  OPT_fpie = 707,                            /* -fpie */
  OPT_fplan9_extensions = 708,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 709,                    /* -fplugin-arg- */
  OPT_fplugin_ = 710,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 711,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 712,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 713,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 714,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 715,                   /* -fpreprocessed */
  OPT_fpretty_templates = 716,               /* -fpretty-templates */
  OPT_fprofile = 717,                        /* -fprofile */
  OPT_fprofile_arcs = 718,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 719,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 720,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 721,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 722,              /* -fprofile-generate= */
  OPT_fprofile_use = 723,                    /* -fprofile-use */
  OPT_fprofile_use_ = 724,                   /* -fprofile-use= */
  OPT_fprofile_values = 725,                 /* -fprofile-values */
  OPT_fprotect_parens = 726,                 /* -fprotect-parens */
  OPT_frandom_seed = 727,                    /* -frandom-seed */
  OPT_frandom_seed_ = 728,                   /* -frandom-seed= */
  OPT_frange_check = 729,                    /* -frange-check */
  OPT_frealloc_lhs = 730,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 731,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 732,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 733,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 734,                /* -frecord-marker=8 */
  OPT_frecursive = 735,                      /* -frecursive */
  OPT_freduced_reflection = 736,             /* -freduced-reflection */
  OPT_freg_struct_return = 737,              /* -freg-struct-return */
  OPT_fregmove = 738,                        /* -fregmove */
  OPT_frename_registers = 739,               /* -frename-registers */
  OPT_freorder_blocks = 740,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 741,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 742,              /* -freorder-functions */
  OPT_frepack_arrays = 743,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 744,           /* -freplace-objc-classes */
  OPT_frepo = 745,                           /* -frepo */
  OPT_frequire_return_statement = 746,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 747,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 748, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 749,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 750,                    /* -fresolution= */
  OPT_frounding_math = 751,                  /* -frounding-math */
  OPT_frtti = 752,                           /* -frtti */
  OPT_fsaw_java_file = 753,                  /* -fsaw-java-file */
  ...
  OPT_fsched_pressure_algorithm_ = 760,      /* -fsched-pressure-algorithm= */
  OPT_fsched_rank_heuristic = 761,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 762,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 763,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 764,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 765,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 766,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 767,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 768,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 769,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 770,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 771,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 772, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 773,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 774,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 775,              /* -fsecond-underscore */
  OPT_fsection_anchors = 776,                /* -fsection-anchors */
  /* OPT_fsee = 777, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 778,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 779,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 780, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 781,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 782,          /* -fselective-scheduling2 */
  OPT_fshort_double = 783,                   /* -fshort-double */
  OPT_fshort_enums = 784,                    /* -fshort-enums */
  OPT_fshort_wchar = 785,                    /* -fshort-wchar */
  OPT_fshow_column = 786,                    /* -fshow-column */
  OPT_fsign_zero = 787,                      /* -fsign-zero */
  OPT_fsignaling_nans = 788,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 789,               /* -fsigned-bitfields */
  OPT_fsigned_char = 790,                    /* -fsigned-char */
  OPT_fsigned_zeros = 791,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 792,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 793,               /* -fsource-filename= */
  OPT_fsource_ = 794,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 795,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 796,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 797,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 798, */                 /* -fsquangle */
  /* OPT_fstack_check = 799, */              /* -fstack-check */
  OPT_fstack_check_ = 800,                   /* -fstack-check= */
  OPT_fstack_limit = 801,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 802,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 803,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 804,                /* -fstack-protector */
  OPT_fstack_protector_all = 805,            /* -fstack-protector-all */
  OPT_fstack_usage = 806,                    /* -fstack-usage */
  OPT_fstats = 807,                          /* -fstats */
  OPT_fstore_check = 808,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 809, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 810,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 811,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 812,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 813, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 814,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 815,                    /* -fsyntax-only */
  OPT_ftabstop_ = 816,                       /* -ftabstop= */
  /* OPT_ftarget_help = 817, */              /* -ftarget-help */
  OPT_ftarget_ = 818,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 819, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 820,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 821,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 822, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 823,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 824,             /* -fthreadsafe-statics */
  OPT_ftime_report = 825,                    /* -ftime-report */
  OPT_ftls_model_ = 826,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 827,               /* -ftoplevel-reorder */
  OPT_ftracer = 828,                         /* -ftracer */
  OPT_ftrapping_math = 829,                  /* -ftrapping-math */
  OPT_ftrapv = 830,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 831,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 832,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 833,                       /* -ftree-ccp */
  OPT_ftree_ch = 834,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 835,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 836,                /* -ftree-copyrename */
  OPT_ftree_cselim = 837,                    /* -ftree-cselim */
  OPT_ftree_dce = 838,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 839,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 840,                       /* -ftree-dse */
  OPT_ftree_forwprop = 841,                  /* -ftree-forwprop */
  OPT_ftree_fre = 842,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 843,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 844,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 845,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 846,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 847,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 848,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 849, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 850,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 851,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 852,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 853,                   /* -ftree-phiprop */
  OPT_ftree_pre = 854,                       /* -ftree-pre */
  OPT_ftree_pta = 855,                       /* -ftree-pta */
  OPT_ftree_reassoc = 856,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 857, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 858,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 859,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 860,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 861,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 862, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 863, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 864,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 865,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 866,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 867,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 868,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 869,                       /* -ftree-vrp */
  OPT_funderscoring = 870,                   /* -funderscoring */
  OPT_funit_at_a_time = 871,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 872,               /* -funroll-all-loops */
  OPT_funroll_loops = 873,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 874,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 875,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 876,             /* -funsigned-bitfields */
  OPT_funsigned_char = 877,                  /* -funsigned-char */
  OPT_funswitch_loops = 878,                 /* -funswitch-loops */
  OPT_funwind_tables = 879,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 880,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 881,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 882,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 883,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 884,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 885,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 886,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 887,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 888,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 889,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 890, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 891,                /* -fvect-cost-model */
  OPT_fverbose_asm = 892,                    /* -fverbose-asm */
  /* OPT_fversion = 893, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 894,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 895,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 896,                    /* -fvisibility= */
  OPT_fvpt = 897,                            /* -fvpt */
  /* OPT_fvtable_gc = 898, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 899, */            /* -fvtable-thunks */
  OPT_fweak = 900,                           /* -fweak */
  OPT_fweb = 901,                            /* -fweb */
  ...
  OPT_fwpa = 906,                            /* -fwpa */
  OPT_fwrapv = 907,                          /* -fwrapv */
  /* OPT_fxref = 908, */                     /* -fxref */
  OPT_fzee = 909,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 910,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 911,                      /* -fzero-link */
  OPT_g = 912,                               /* -g */
  OPT_gant = 913,                            /* -gant */
  OPT_gcoff = 914,                           /* -gcoff */
  OPT_gdwarf_ = 915,                         /* -gdwarf- */
  OPT_gen_decls = 916,                       /* -gen-decls */
  OPT_ggdb = 917,                            /* -ggdb */
  OPT_gnat = 918,                            /* -gnat */
  OPT_gnatO = 919,                           /* -gnatO */
  OPT_gno_strict_dwarf = 920,                /* -gno-strict-dwarf */
  OPT_gstabs = 921,                          /* -gstabs */
  OPT_gstabs_ = 922,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 923,                   /* -gstrict-dwarf */
  OPT_gtoggle = 924,                         /* -gtoggle */
  OPT_gvms = 925,                            /* -gvms */
  OPT_gxcoff = 926,                          /* -gxcoff */
  OPT_gxcoff_ = 927,                         /* -gxcoff+ */
  OPT_h = 928,                               /* -h */
  OPT_idirafter = 929,                       /* -idirafter */
  OPT_imacros = 930,                         /* -imacros */
  OPT_imultilib = 931,                       /* -imultilib */
  OPT_include = 932,                         /* -include */
  OPT_iplugindir_ = 933,                     /* -iplugindir= */
  OPT_iprefix = 934,                         /* -iprefix */
  OPT_iquote = 935,                          /* -iquote */
  OPT_isysroot = 936,                        /* -isysroot */
  OPT_isystem = 937,                         /* -isystem */
  OPT_iwithprefix = 938,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 939,               /* -iwithprefixbefore */
  OPT_k8 = 940,                              /* -k8 */
  OPT_l = 941,                               /* -l */
  OPT_lang_asm = 942,                        /* -lang-asm */
  OPT_mabi_ = 943,                           /* -mabi= */
  OPT_mabort_on_noreturn = 944,              /* -mabort-on-noreturn */
  OPT_mandroid = 945,                        /* -mandroid */
  OPT_mapcs = 946,                           /* -mapcs */
  OPT_mapcs_float = 947,                     /* -mapcs-float */
  OPT_mapcs_frame = 948,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 949,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 950,               /* -mapcs-stack-check */
  OPT_march_ = 951,                          /* -march= */
  OPT_marm = 952,                            /* -marm */
  OPT_mbig_endian = 953,                     /* -mbig-endian */
  OPT_mbionic = 954,                         /* -mbionic */
  OPT_mcallee_super_interworking = 955,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 956,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 957,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 958,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 959,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 960,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 961,                   /* -mfp16-format= */
  OPT_mfp_ = 962,                            /* -mfp= */
  OPT_mfpe = 963,                            /* -mfpe */
  OPT_mfpe_ = 964,                           /* -mfpe= */
  OPT_mfpu_ = 965,                           /* -mfpu= */
  OPT_mglibc = 966,                          /* -mglibc */
  OPT_mhard_float = 967,                     /* -mhard-float */
  OPT_mlittle_endian = 968,                  /* -mlittle-endian */
  OPT_mlong_calls = 969,                     /* -mlong-calls */
  OPT_mpic_register_ = 970,                  /* -mpic-register= */
  OPT_mpoke_function_name = 971,             /* -mpoke-function-name */
  OPT_msched_prolog = 972,                   /* -msched-prolog */
  OPT_msingle_pic_base = 973,                /* -msingle-pic-base */
  OPT_msoft_float = 974,                     /* -msoft-float */
  OPT_mstructure_size_boundary_ = 975,       /* -mstructure-size-boundary= */
  OPT_mthumb = 976,                          /* -mthumb */
  OPT_mthumb_interwork = 977,                /* -mthumb-interwork */
  OPT_mtp_ = 978,                            /* -mtp= */
  OPT_mtpcs_frame = 979,                     /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 980,                /* -mtpcs-leaf-frame */
  OPT_mtune_ = 981,                          /* -mtune= */
  OPT_muclibc = 982,                         /* -muclibc */
  OPT_munaligned_access = 983,               /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 984,     /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 985,       /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 986,               /* -mword-relocations */
  OPT_mwords_little_endian = 987,            /* -mwords-little-endian */
  OPT_n = 988,                               /* -n */
  OPT_no_canonical_prefixes = 989,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 990,               /* -no-integrated-cpp */
  OPT_nocpp = 991,                           /* -nocpp */
  OPT_nodefaultlibs = 992,                   /* -nodefaultlibs */
  OPT_nostartfiles = 993,                    /* -nostartfiles */
  OPT_nostdinc = 994,                        /* -nostdinc */
  OPT_nostdinc__ = 995,                      /* -nostdinc++ */
  OPT_nostdlib = 996,                        /* -nostdlib */
  OPT_o = 997,                               /* -o */
  OPT_p = 998,                               /* -p */
  OPT_pass_exit_codes = 999,                 /* -pass-exit-codes */
  OPT_pedantic = 1000,                       /* -pedantic */
  OPT_pedantic_errors = 1001,                /* -pedantic-errors */
  OPT_pg = 1002,                             /* -pg */
  OPT_pie = 1003,                            /* -pie */
  OPT_pipe = 1004,                           /* -pipe */
  OPT_posix = 1005,                          /* -posix */
  OPT_print_file_name_ = 1006,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1007,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1008,          /* -print-multi-directory */
  OPT_print_multi_lib = 1009,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1010,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1011,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1012,               /* -print-prog-name= */
  OPT_print_search_dirs = 1013,              /* -print-search-dirs */
  OPT_print_sysroot = 1014,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1015,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1016,                        /* -profile */
  OPT_pthread = 1017,                        /* -pthread */
  OPT_quiet = 1018,                          /* -quiet */
  OPT_r = 1019,                              /* -r */
  OPT_rdynamic = 1020,                       /* -rdynamic */
  OPT_remap = 1021,                          /* -remap */
  OPT_s = 1022,                              /* -s */
  OPT_s_bc_abi = 1023,                       /* -s-bc-abi */
  OPT_save_temps = 1024,                     /* -save-temps */
  OPT_save_temps_ = 1025,                    /* -save-temps= */
  OPT_shared = 1026,                         /* -shared */
  OPT_shared_libgcc = 1027,                  /* -shared-libgcc */
  /* OPT_specs = 1028, */                    /* -specs */
  OPT_specs_ = 1029,                         /* -specs= */
  OPT_static = 1030,                         /* -static */
  OPT_static_libgcc = 1031,                  /* -static-libgcc */
  OPT_static_libgcj = 1032,                  /* -static-libgcj */
  OPT_static_libgfortran = 1033,             /* -static-libgfortran */
  OPT_static_libgo = 1034,                   /* -static-libgo */
  OPT_static_libstdc__ = 1035,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1036, */                /* -std=c++03 */
  OPT_std_c__0x = 1037,                      /* -std=c++0x */
  OPT_std_c__98 = 1038,                      /* -std=c++98 */
  OPT_std_c1x = 1039,                        /* -std=c1x */
  /* OPT_std_c89 = 1040, */                  /* -std=c89 */
  OPT_std_c90 = 1041,                        /* -std=c90 */
  OPT_std_c99 = 1042,                        /* -std=c99 */
  /* OPT_std_c9x = 1043, */                  /* -std=c9x */
  OPT_std_f2003 = 1044,                      /* -std=f2003 */
  OPT_std_f2008 = 1045,                      /* -std=f2008 */
  OPT_std_f95 = 1046,                        /* -std=f95 */
  OPT_std_gnu = 1047,                        /* -std=gnu */
  OPT_std_gnu__0x = 1048,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1049,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1050,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1051, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1052,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1053,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1054, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1055, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1056,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1057, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1058, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1059,                     /* -std=legacy */
  OPT_symbolic = 1060,                       /* -symbolic */
  OPT_t = 1061,                              /* -t */
  OPT_time = 1062,                           /* -time */
  OPT_time_ = 1063,                          /* -time= */
  OPT_tno_android_cc = 1064,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1065,                 /* -tno-android-ld */
  OPT_traditional = 1066,                    /* -traditional */
  OPT_traditional_cpp = 1067,                /* -traditional-cpp */
  OPT_trigraphs = 1068,                      /* -trigraphs */
  OPT_u = 1069,                              /* -u */
  OPT_undef = 1070,                          /* -undef */
  OPT_v = 1071,                              /* -v */
  OPT_version = 1072,                        /* -version */
  OPT_w = 1073,                              /* -w */
  OPT_wrapper = 1074,                        /* -wrapper */
  OPT_x = 1075,                              /* -x */
  OPT_z = 1076,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
