...
public:
  ...
  virtual ::java::util::logging::Formatter *getFormatter () { return formatter; }
  virtual void setFormatter (::java::util::logging::Formatter *);
  virtual ::java::lang::String *getEncoding () { return encoding; }
  virtual void setEncoding (::java::lang::String *);
  virtual ::java::util::logging::Filter *getFilter () { return filter; }
