...
#define VEC_CONCAT_EXPR_CHECK(t)	TREE_CHECK (t, VEC_CONCAT_EXPR)
#define VEC_CONCAT3_EXPR_CHECK(t)	TREE_CHECK (t, VEC_CONCAT3_EXPR)
#define VEC_GET_PART_EXPR_CHECK(t)	TREE_CHECK (t, VEC_GET_PART_EXPR)
