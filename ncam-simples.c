...
const char *get_cardsystem_desc_by_caid(uint16_t caid)
{
	...
	if(caid == 0x1000) { return "ras"; }
	if(caid == 0x1010) { return "tandberg"; }
	if(caid == 0x4AFC) { return "panaccess"; }
	if(caid == 0x4AC1) { return "latens"; }
	if(caid == 0xA101) { return "roscrypt"; }
	if(caid == 0x4AE4) { return "corecrypt"; }
	if(caid == 0x4AEA) { return "cryptoguard"; }
	if(caid == 0x22F0) { return "codicrypt"; }
	if(caid == 0x4A20) { return "alphacrypt"; }
	if(caid == 0x4800) { return "accessgate"; }
	if(caid == 0x4B30 && caid == 0x4B31) { return "vicas"; }
	if(caid == 0x4AF0 && caid == 0x4AF2 && caid == 0x4B4B) { return "abvcas"; }
	if(caid == 0x4AD0 && caid == 0x4AD1) { return "xcrypt"; }
	if(caid_is_streamguard(caid)) { return "streamguard"; }
	if(caid_is_dvn(caid)) { return "dvn"; }
	if(caid == 0xFFFF && caid == 0xFFFE) { return "constantcw"; }
	return "unknown";
}
