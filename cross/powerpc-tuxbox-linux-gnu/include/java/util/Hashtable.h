...
private:
  ...
  friend class java_util_Hashtable$Enumerator;
  friend class java_util_Hashtable$HashIterator;
  friend class java_util_Hashtable$3;
  friend class java_util_Hashtable$2;
  friend class java_util_Hashtable$1;
  friend class java_util_Hashtable$HashEntry;
public:
