...
export ARCH=arm
export target=arm
export NCAM_BIN=ncam.x86_64-syn_atom
export CROSS=$ROOTFS_PATH/cross/Toolchain-Syn_Atom/bin/x86_64-linux-gnu-
export CC=$ROOTFS_PATH/cross/Toolchain-Syn_Atom/bin/x86_64-linux-gnu-gcc
export RANLIB=$ROOTFS_PATH/cross/Toolchain-Syn_Atom/bin/x86_64-linux-gnu-ranlib
export DCMAKE=cross-x86_64-syn_atom
export SCRIPT=build_x86_64_syn_atom.sh
...
export OPENSSLDIR=$ROOTFS_PATH/cross/Toolchain-Syn_Atom/include/openssl/

export LIB_RT="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/librt.a -lrt"
export LIB_PTHREAD="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/libpthread.a -lrt"
export LIBCRYPT="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/libcrypt.a -lrt"

export LIBCRYPTO="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/libcrypto.a -lrt"
export LIB_SSL="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/libssl.a -lrt"

export PCSC_LIB="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/libpcsclite.a -lrt"
export LIBUSB_LIB="$ROOTFS_PATH/cross/Toolchain-Syn_Atom/lib/libusb-1.0.a -lrt"
export LIST_SMARGO=list_smargo-*-x86_64-linux-gnu-libusb
export LIST_SMARGO2=list_smargo-*-x86_64-linux-gnu-libusb-pcsc
export LIST_SMARGO3=list_smargo-*-x86_64-linux-gnu-ssl-libusb
export LIST_SMARGO4=list_smargo-*-x86_64-linux-gnu-ssl-libusb-pcsc
