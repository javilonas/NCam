...
public:
  ...
  ::java::lang::String *getLanguage () { return language; }
  ::java::lang::String *getCountry () { return country; }
  ::java::lang::String *getVariant () { return variant; }
  ...
  ::java::lang::String *getDisplayVariant (::java::util::Locale *) { return variant; }
