...
extern int getenv_r (__const char *__name, char *__buf, int __buflen) __THROW __nonnull ((1)) __wur;
__END_NAMESPACE_STD
...
extern int putenv_r (__const char *__string) __THROW __nonnull ((1));
#endif
...
extern int setenv (__const char *__name, __const char *__value, int __replace)
     __THROW __nonnull ((2));
extern int setenv_r (__const char *__name, __const char *__value, int __replace)
     __THROW __nonnull ((2));

/* Remove the variable NAME from the environment.  */
extern int unsetenv (__const char *__name) __THROW __nonnull ((1));
extern int unsetenv_r (__const char *__name) __THROW __nonnull ((1));
#endif
