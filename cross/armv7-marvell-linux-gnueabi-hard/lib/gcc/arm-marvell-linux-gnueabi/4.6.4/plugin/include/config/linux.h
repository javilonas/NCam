...
/* Tsai111220: Fix Mantis 0001928: gingerbread_bg2 built by
 * marvell-linux-androideabi toolchain failed to boot up due to sin/cos
 * optimization in SkMath.cpp.
 *
 * Avoid BIONIC's problem.
 *
