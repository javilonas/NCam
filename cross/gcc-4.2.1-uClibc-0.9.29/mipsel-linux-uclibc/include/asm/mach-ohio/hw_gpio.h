...
\*-------------------------------------------------------------------------------------*/
/* GPIO registers */
/*--- #define GPIO_IN         (*(volatile unsigned *)(OHIO_GPIO_BASE+0x0)) ---*/
/*--- #define GPIO_OUT   		(*(volatile unsigned int *)(OHIO_GPIO_BASE+0x4)) ---*/
/*--- #define GPIO_DIR   		(*(volatile unsigned int *)(OHIO_GPIO_BASE+0x8)) ---*/ /* 0=o/p, 1=i/p */
/*--- #define GPIO_EN    		(*(volatile unsigned int *)(OHIO_GPIO_BASE+0xc)) ---*/ /* 0=GPIO Mux 1=GPIO */

#define OHIO_CVR    (*(volatile unsigned int *)(OHIO_GPIO_BASE+0x14))   /* see _chip_version */
#define OHIO_DIDR1  (*(volatile unsigned int *)(OHIO_GPIO_BASE+0x18))
#define OHIO_DIDR2  (*(volatile unsigned int *)(OHIO_GPIO_BASE+0x1C))
...
#define OHIO_CHIP_ID_212    0x18                  /* Ohio212 Chip ID */
#define OHIO_CHIP_ID        0x2b
