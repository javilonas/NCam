...
export ARCH=mips
export target=mips
export NCAM_BIN=ncam-router-openwrt-brcm47xx-libusb.mips
...
export DCMAKE=cross-mips-routerwrtbrcm47xx-linux-uclibc-libusb
export SCRIPT=build_mips-router-openwrt-brcm47xx-libusb.sh
...
export LIBUSB_LIB="$ROOTFS_PATH/cross/OpenWrt-SDK-15.05-brcm47xx-generic_gcc-4.8-linaro_uClibc-0.9.33.2.Linux-x86_64/staging_dir/toolchain-mipsel_mips32_gcc-4.8-linaro_uClibc-0.9.33.2/lib/libusb-1.0.a -lrt"
export LIST_SMARGO=list_smargo-*-mipsel-openwrt-linux-uclibc-libusb
